            ...
            <?php $__empty_1 = true; $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="program-card bg-white rounded-2xl shadow-lg overflow-hidden h-full flex flex-col"
                    ...
                    <div class="relative h-56 overflow-hidden">
                        ...
                        <?php if($program->is_featured ?? false): ?>
                    ...
                    <div class="p-6 flex-grow flex flex-col">
                        ...
                        <a href="<?php echo e(route('programs.show', $program->slug)); ?>" class="hover:text-blue-600 transition-colors">
                        ...
                        <div class="flex justify-between items-center mt-auto pt-4 border-t border-gray-100">
                            <div>
                                <?php if($hasDiscount && ($program->tuition ?? 0) > 0): ?>
                            ...
                            <a href="<?php echo e(route('programs.show', $program->slug)); ?>" class="px-5 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all hover:shadow-lg font-semibold group flex items-center">
                    ...
                    <div class="md:w-2/3 lg:w-3/4 p-6 flex flex-col">
                        ...
                        <div class="flex justify-between items-center mt-auto pt-4 border-t border-gray-100">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('programs.show', $program->slug)); ?>" class="px-5 py-2.5 border border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50 transition font-semibold">
                                    Learn More
                                </a>

            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="event-card bg-white rounded-3xl overflow-hidden shadow-xl hover-scale event-card-gradient animate-fade-in-up"
                            data-type="<?php echo e($event['type']); ?>" style="animation-delay: <?php echo e($index * 150); ?>ms">
                            <div class="relative overflow-hidden h-56">
                                ...
                                <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                                    <div class="text-white font-semibold"><?php echo e($event->date->format('M d, Y')); ?> • <?php echo e($event->time); ?>
                    ...
                    ($event->type == 'workshop' ? 'bg-green-100 text-green-600' :
                        ($event->type == 'networking' ? 'bg-purple-100 text-purple-600' : 'bg-orange-100 text-orange-600'))); ?>">
                                ...
                                <div class="flex gap-3">
                                    <button onclick="registerForEvent(<?php echo e($event->id); ?>)"
                ...
                <div class="space-y-12">
                    <?php $__currentLoopData = $timelineEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ($event->status == 'active' ? 'text-blue-600' : 'text-gray-600')); ?>"></i>
                                    ...
                                    <div
                                        class="md:ml-8 flex-1 bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 <?php echo e($event->status == 'active' ? 'border-2 border-blue-300' : ''); ?>">

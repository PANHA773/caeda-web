        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-white">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <?php if($hero->stats): ?>
                        <?php $__currentLoopData = $hero->stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <form id="donationForm" method="POST" action="<?php echo e(route('donation.submit')); ?>" class="p-6 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-3 mb-6">
                                <?php $__currentLoopData = [25, 50, 100, 250, 500, 1000]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button"
...
<section id="impact" class="py-24 px-4 md:px-8 bg-gradient-to-b from-white via-blue-50/50 to-blue-100/30">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <?php $__currentLoopData = $impactStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article
                        ...
                        <div class="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-md">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="px-4 py-1.5 rounded-full text-xs font-bold text-white
                                             ...
                                             bg-gradient-to-r <?php echo e($story->color ?? 'from-blue-500 to-purple-600'); ?>">

        ...
        <?php if($footer): ?>
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <ul class="list-disc ml-5 text-gray-700">
                        <?php $__currentLoopData = $footer->contact_info ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

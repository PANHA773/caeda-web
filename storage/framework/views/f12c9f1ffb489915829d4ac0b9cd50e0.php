        ...
        <div class="bg-white rounded-xl shadow overflow-hidden">
            <table class="min-w-full text-sm text-left">
                ...
                <tbody class="divide-y">
                    <?php $__empty_1 = true; $__currentLoopData = $successStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <form action="<?php echo e(route('admin.success-stories.destroy', $story->id)); ?>" method="POST"

...
<?php $__env->startSection('title', 'Edit Program - Admin CAEDA'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8 animate-fade-in-up">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Update program details for <?php echo e($program->title); ?></p>
                </div>
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <?php else: ?>
                            <span class="program-status-badge inactive">Inactive</span>
                        <?php endif; ?>
                        <?php if($program->is_featured): ?>
                            <span class="program-status-badge featured">Featured</span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 flex items-center space-x-4">
                <div class="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden">
                    <div class="h-full bg-gradient-to-r from-green-500 to-emerald-600 w-2/3"></div>
                </div>
                <div class="text-sm text-gray-600">
                    <span class="font-semibold text-green-600">Editing Mode</span>
                </div>
            </div>
        </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        <h3 class="text-sm font-semibold text-red-800">
                            <?php echo e(count($errors)); ?> error(s) need to be fixed:
                        </h3>
        ...
        <?php if(session('success')): ?>
            <div class="mb-8 p-5 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 rounded-xl animate-fade-in-up animate-delay-100">
        ...
        <form action="<?php echo e(route('admin.programs.update', $program->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8" id="programForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-card rounded-2xl p-8 animate-fade-in-up animate-delay-100">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="form-group">
                                        ...
                                        <select id="category" 
                                            ...
                                            <option value="Technology" <?php echo e(old('category', $program->category) == 'Technology' ? 'selected' : ''); ?>>Technology</option>
                                            <option value="Business" <?php echo e(old('category', $program->category) == 'Business' ? 'selected' : ''); ?>>Business</option>
                                            <option value="Science" <?php echo e(old('category', $program->category) == 'Science' ? 'selected' : ''); ?>>Science</option>
                                            <option value="Arts" <?php echo e(old('category', $program->category) == 'Arts' ? 'selected' : ''); ?>>Arts</option>
                                            <option value="Health" <?php echo e(old('category', $program->category) == 'Health' ? 'selected' : ''); ?>>Health</option>
                                            <option value="Engineering" <?php echo e(old('category', $program->category) == 'Engineering' ? 'selected' : ''); ?>>Engineering</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="level" 
                                            ...
                                            <option value="expert" <?php echo e(old('level', $program->level) == 'expert' ? 'selected' : ''); ?>>Expert</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="short_description" 
                                              ...
                                              placeholder="Brief overview of the program"><?php echo e(old('short_description', $program->short_description)); ?></textarea>
                                    <div id="short_desc_counter" class="text-sm text-gray-500 mt-1 text-right">0/200 characters</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="mode" 
                                        ...
                                        <option value="online" <?php echo e(old('mode', $program->mode) == 'online' ? 'selected' : ''); ?>>Online</option>
                                        <option value="offline" <?php echo e(old('mode', $program->mode) == 'offline' ? 'selected' : ''); ?>>On-campus</option>
                                        <option value="hybrid" <?php echo e(old('mode', $program->mode) == 'hybrid' ? 'selected' : ''); ?>>Hybrid</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="<?php echo e(old('application_deadline', optional($program->application_deadline)->format('Y-m-d'))); ?>"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" 
                                           id="students" 
                                           name="students" 
                                           value="<?php echo e(old('students', $program->students)); ?>"
                                           min="0"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                    <p class="text-gray-500 text-sm mt-2">Current: <?php echo e($program->students); ?> students</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section p-6 bg-white rounded-xl border border-gray-200">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" 
                                          ...
                                          placeholder="Detailed description including curriculum, learning outcomes, prerequisites..."><?php echo e(old('description', $program->description)); ?></textarea>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="form-section p-6 bg-white rounded-xl border border-gray-200">
                            <div class="flex items-center mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Update cover image</p>
                                </div>
                            </div>
                            ...
                            <?php if($program->image): ?>
                                <div class="mb-6">
                                    ...
                                    <div class="current-image rounded-xl overflow-hidden">
                                        <img src="<?php echo e($program->image_url); ?>" 
                            ...
                            <div class="image-preview mb-6">
                                <div id="image-preview-container" class="w-full h-48 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center overflow-hidden">
                                    <div class="text-center">
                                        ...
                                        <p class="text-gray-500 text-sm">New image preview</p>
                        ...
                        <div class="form-section p-6 bg-white rounded-xl border border-gray-200">
                            <div class="flex items-center mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Update tuition and discounts</p>
                                </div>
                            </div>
                            
                            
                            <input type="hidden" id="final_price" name="final_price" value="<?php echo e(old('final_price', $program->final_price)); ?>">
                            ...
                            <div class="space-y-6">
                                <div class="form-group price-input">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               id="tuition" 
                                               name="tuition" 
                                               value="<?php echo e(old('tuition', $program->tuition)); ?>"
                                               required
                                               step="0.01"
                                               min="0"
                                ...
                                <div class="form-group price-input">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               id="discount" 
                                               name="discount" 
                                               value="<?php echo e(old('discount', $program->discount)); ?>"
                                               step="0.01"
                                               min="0"
                                               class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                                ...
                                <div id="price-summary" class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200">
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span id="tuition-summary" class="font-medium">$<?php echo e(number_format($program->tuition, 2)); ?></span>
                                        </div>
                                        <div id="discount-row" class="flex justify-between items-center <?php echo e($program->has_discount ? '' : 'hidden'); ?>">
                                            <span class="text-gray-600">Discount:</span>
                                            <span id="discount-summary" class="font-medium text-green-600">-<?php echo e($program->has_discount ? '$' . number_format($program->tuition - $program->final_price, 2) : '$0.00'); ?></span>
                                        </div>
                                        <div class="border-t border-blue-200 pt-2 mt-2 flex justify-between items-center">
                                            ...
                                            <span id="final-price-summary" class="text-xl font-bold text-blue-700">$<?php echo e(number_format($program->final_price, 2)); ?></span>
                                        </div>
                                    </div>
                                </div>
                                
                                <div id="savings-calc" class="<?php echo e($program->has_discount ? '' : 'hidden'); ?> p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-sm text-gray-600">Students save</p>
                                            <p class="text-2xl font-bold text-green-700" id="savings-amount">
                                                <?php echo e($program->has_discount ? '$' . number_format($program->tuition - $program->final_price, 2) : '$0'); ?>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           id="badge" 
                                           name="badge" 
                                           value="<?php echo e(old('badge', $program->badge)); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="badge_color" 
                                        ...
                                        <option value="bg-blue-600" <?php echo e(old('badge_color', $program->badge_color) == 'bg-blue-600' ? 'selected' : ''); ?>>Blue</option>
                                        <option value="bg-red-600" <?php echo e(old('badge_color', $program->badge_color) == 'bg-red-600' ? 'selected' : ''); ?>>Red</option>
                                        <option value="bg-green-600" <?php echo e(old('badge_color', $program->badge_color) == 'bg-green-600' ? 'selected' : ''); ?>>Green</option>
                                        <option value="bg-yellow-600" <?php echo e(old('badge_color', $program->badge_color) == 'bg-yellow-600' ? 'selected' : ''); ?>>Yellow</option>
                                        <option value="bg-purple-600" <?php echo e(old('badge_color', $program->badge_color) == 'bg-purple-600' ? 'selected' : ''); ?>>Purple</option>
                                        <option value="bg-pink-600" <?php echo e(old('badge_color', $program->badge_color) == 'bg-pink-600' ? 'selected' : ''); ?>>Pink</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section p-6 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl border border-indigo-200">
                            <h3 class="text-lg font-bold text-gray-900 mb-4">Program Statistics</h3>
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Created:</span>
                                    <span class="font-medium"><?php echo e($program->created_at->format('M d, Y')); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Last Updated:</span>
                                    <span class="font-medium"><?php echo e($program->updated_at->format('M d, Y')); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Program ID:</span>
                                    <span class="font-mono text-sm"><?php echo e($program->id); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Slug:</span>
                                    <span class="font-mono text-sm truncate max-w-[150px]"><?php echo e($program->slug); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Current Rating:</span>
                                    <span class="font-medium"><?php echo e(number_format($program->rating, 1)); ?> ⭐</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-12 pt-8 border-t border-gray-200">
                    <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                        ...
                        <div class="flex space-x-4">
                            <button type="button" 
                                    onclick="window.location.href='<?php echo e(route('admin.programs.index')); ?>'"
                            ...
                            <button type="submit" 
                                    class="px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-700 text-white font-semibold rounded-xl hover:from-green-700 hover:to-emerald-800 transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.removeImage = function() {
        ...
        if (removeInput.value === '0') {
            ...
            alert('Current image will be removed after update.');
        } else {
            removeInput.value = '0';
            if (currentImage) {
    ...
    window.calculateFinalPrice = function() {
        ...
        if (discount > 0 && discount < tuition) {
            ...
            discountSummary.textContent = '-$0.00';
        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/programs/edit.blade.php ENDPATH**/ ?>
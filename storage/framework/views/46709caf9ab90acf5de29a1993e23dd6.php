                ...
                <?php $__empty_1 = true; $__currentLoopData = $workshops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workshop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="workshop-card bg-white rounded-xl shadow" data-category="<?php echo e($workshop->category); ?>">
                        ...
                        <div class="relative">
                            ...
                            <?php if($hasImg): ?>
                                <img id="thumb-<?php echo e($workshop->id); ?>" src="<?php echo e(asset('storage/' . $workshop->image)); ?>"
                                    class="w-full h-44 object-cover rounded-t-xl">
                            <?php else: ?>
                                <div id="thumb-<?php echo e($workshop->id); ?>"
                            ...
                            <?php if($workshop->video): ?>
                                <div id="video-<?php echo e($workshop->id); ?>" class="hidden">
                                    <?php if(preg_match('/^https?:\/\//i', $workshop->video)): ?>
                                        <iframe class="w-full h-44 rounded-t-xl" data-src="<?php echo e($workshop->video_url); ?>" frameborder="0"
                                            allowfullscreen></iframe>
                                    <?php else: ?>
                                        <video class="w-full h-44 rounded-t-xl" controls preload="none">
                                            <source src="<?php echo e($workshop->video_url); ?>" type="video/mp4">
                                ...
                                <button onclick="playWorkshop(<?php echo e($workshop->id); ?>)" class="absolute inset-0 flex items-center justify-center
                        ...
                        <div class="flex justify-between px-4 py-3 border-t bg-gray-50">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.workshops.destroy', $workshop->id)); ?>"

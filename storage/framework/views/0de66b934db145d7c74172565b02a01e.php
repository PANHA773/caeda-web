                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        <select class="filter-btn appearance-none bg-white border border-gray-300 rounded-xl px-4 py-2.5 pr-8 focus:outline-none focus:border-blue-500 text-sm">
                            ...
                            <?php $__currentLoopData = ['blue','red','green','yellow','purple','pink','indigo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

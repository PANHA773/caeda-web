...
<?php $__env->startSection('title', $post->title ?? 'News Detail'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="min-h-screen bg-[#fcfdff] pb-24">
        ...
        <div class="container mx-auto px-4 pt-8 mb-12">
            <div class="flex items-center justify-between">
                <a href="<?php echo e(route('news')); ?>" class="inline-flex items-center text-indigo-600 font-bold group">
                    <span
                ...
                <nav class="hidden md:flex items-center space-x-3 text-sm font-bold text-gray-400">
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-indigo-600 uppercase tracking-wider">Home</a>
                    <i class="fas fa-chevron-right text-[10px]"></i>
                    <a href="<?php echo e(route('news')); ?>" class="hover:text-indigo-600 uppercase tracking-wider">News</a>
                    <i class="fas fa-chevron-right text-[10px]"></i>
                    <span class="text-indigo-600 uppercase tracking-wider truncate max-w-[200px]"><?php echo e($post->title); ?></span>
                </nav>
            </div>
        </div>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <header class="mb-12 text-center md:text-left">
                    <div class="flex flex-wrap justify-center md:justify-start gap-3 mb-6">
                        <?php $__currentLoopData = $post->tags ?? ['General']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-5">
                            <div class="relative">
                                <img src="<?php echo e(data_get($post, 'user.avatar', 'https://ui-avatars.com/api/?name=' . urlencode(data_get($post, 'user.name', 'CAEDA')) . '&background=4F46E5&color=fff&bold=true')); ?>"
                            ...
                            <div>
                                <div class="flex items-center">
                                    <h4 class="font-black text-gray-900 text-lg"><?php echo e(data_get($post, 'user.name', 'CAEDA')); ?>
                                ...
                                <p class="text-indigo-600 font-bold text-xs uppercase tracking-widest">
                                    <?php echo e(data_get($post, 'user.role', 'Principal Contributor')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex md:flex-col md:items-end gap-6 md:gap-1">
                            <div class="flex items-center text-gray-400 font-bold text-sm">
                                ...
                                <?php echo e(optional($post->published_at)->format('F d, Y')); ?>
                ...
                <?php if($post->image): ?>
                    <div class="mb-16 rounded-[3rem] overflow-hidden shadow-2xl shadow-indigo-100">
                        <img src="<?php echo e(Str::startsWith($post->image, ['http://', 'https://']) ? $post->image : asset($post->image)); ?>"
                            alt="<?php echo e($post->title); ?>" class="w-full h-auto object-cover max-h-[600px]">
                    </div>
                <?php endif; ?>
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between gap-8">
                        <div class="flex items-center space-x-12">
                            <div class="text-center group">
                                <div class="text-3xl font-black text-indigo-600 mb-1" id="likes-number-<?php echo e($post->id); ?>">
                                    <?php echo e($post->likes); ?></div>
                                <div class="text-xs font-bold text-gray-400 uppercase tracking-widest">Appreciations</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-black text-purple-600 mb-1" id="comments-number-<?php echo e($post->id); ?>">
                                    <?php echo e($post->comments); ?></div>
                                <div class="text-xs font-bold text-gray-400 uppercase tracking-widest">Conversations</div>
                            </div>
                        </div>

                        <div class="flex flex-wrap justify-center gap-4">
                            <button onclick="likePost(<?php echo e($post->id); ?>, this)"
                                data-liked="<?php echo e($post->is_liked ? 'true' : 'false'); ?>"
                                class="interaction-btn-v2 <?php echo e($post->is_liked ? 'active' : ''); ?>">
                                <i class="<?php echo e($post->is_liked ? 'fas fa-heart' : 'far fa-heart'); ?> mr-3"></i>
                                <span
                                    id="like-button-text-<?php echo e($post->id); ?>"><?php echo e($post->is_liked ? 'Appreciated' : 'Appreciate'); ?></span>
                            </button>
                            ...
                            <div class="relative group">
                                ...
                                <div id="share-dropdown"
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        ...
                                        <button onclick="copyLink('<?php echo e(url()->current()); ?>')"
                ...
                <section id="discussion" class="mb-20">
                    <div class="flex items-center justify-between mb-12">
                        ...
                        <span
                            class="px-5 py-2 rounded-full bg-white border border-gray-100 text-sm font-black text-indigo-600 shadow-sm"><?php echo e($post->comments); ?>
                    ...
                    <div class="bg-indigo-50/50 p-8 md:p-12 rounded-[3rem] mb-16 border border-indigo-100/50">
                        <form id="comment-form-<?php echo e($post->id); ?>" onsubmit="submitComment(event, <?php echo e($post->id); ?>)"
                            class="space-y-6">
                            <?php echo csrf_field(); ?>
                    ...
                    <div id="comments-list-<?php echo e($post->id); ?>" class="space-y-8">
                        <?php $__empty_1 = true; $__currentLoopData = $post->commentsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <div class="flex-1">
                                        <div class="flex flex-wrap items-center justify-between gap-2 mb-4">
                                            <h4 class="text-xl font-black text-gray-900">
                                                <?php echo e($comment->name ?? 'Community Member'); ?></h4>
                                            <div
                                        ...
                                        <p class="text-gray-600 text-lg leading-relaxed italic">"<?php echo e($comment->content); ?>"</p>
    ...
    <div class="sticky-share font-black">
        <button onclick="likePost(<?php echo e($post->id); ?>, this)" class="sticky-share-btn" title="Appreciate">
        ...
        <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>"
            class="sticky-share-btn text-blue-600" title="Facebook">
            <i class="fab fa-facebook-f"></i>
        </a>
        <a target="_blank" href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>"
            class="sticky-share-btn text-blue-400" title="Twitter">
            <i class="fab fa-twitter"></i>
        </a>
        <button onclick="copyLink('<?php echo e(url()->current()); ?>')" class="sticky-share-btn text-indigo-600" title="Copy Link">

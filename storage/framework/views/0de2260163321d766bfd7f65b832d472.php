...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="highlight_title" id="highlight_title" value="<?php echo e(old('highlight_title', $hero->highlight_title)); ?>"
                   class="w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300">
            <?php $__errorArgs = ['highlight_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-600 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <div id="stats-container">
                ...
                ?>
                <?php $__currentLoopData = $oldStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

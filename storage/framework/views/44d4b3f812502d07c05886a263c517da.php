<?php $__env->startSection('title', 'Edit Staff - ' . $staff->name); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-500">Update the details of "<?php echo e($staff->name); ?>"</p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-gray-900">Edit Staff Information</h2>
        ...
        <form action="<?php echo e(route('admin.staff.update', $staff->id)); ?>" 
              method="POST" 
                    ...
                    <div>
                        ...
                        <div class="relative w-32">
                            <input type="number" 
                                   name="order" 
                                   id="order" 
                                   value="<?php echo e(old('order', $staff->order)); ?>"
                                   class="w-full pl-11 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                            <div class="absolute left-3 top-1/2 transform -translate-y-1/2">
                                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" 
                                   name="position" 
                                   id="position" 
                                   value="<?php echo e(old('position', $staff->position)); ?>"
                                   required
                                   class="w-full pl-11 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                        ...
                        <?php else: ?>
                            <div class="w-48 h-48 rounded-2xl bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center">
                                <div class="text-center">
                                    <div class="w-16 h-16 mb-4 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center text-white font-semibold text-2xl mx-auto">
            ...
            <div class="mt-8">
                ...
                <div class="relative">
                    <textarea name="bio" 
                              ...
                              placeholder="Brief biography about the staff member..."><?php echo e(old('bio', $staff->bio)); ?></textarea>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" 
                               name="department" 
                               id="department" 
                               value="<?php echo e(old('department', $staff->department)); ?>"
                               class="w-full pl-11 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
            ...
            <div class="mt-8 p-4 bg-gray-50 rounded-xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="p-3 bg-white rounded-lg">
                        ...
                        <p class="text-sm font-medium text-gray-900"><?php echo e($staff->id); ?></p>
                    </div>
                    <div class="p-3 bg-white rounded-lg">
                        <p class="text-xs text-gray-500">Created</p>
                        <p class="text-sm text-gray-900"><?php echo e($staff->created_at->format('M d, Y')); ?></p>
                    </div>
                    <div class="p-3 bg-white rounded-lg">
                        <p class="text-xs text-gray-500">Last Updated</p>
                        <p class="text-sm text-gray-900"><?php echo e($staff->updated_at->format('M d, Y')); ?></p>
                    </div>
                </div>
            </div>
...
<form id="deleteForm" 
      action="<?php echo e(route('admin.staff.destroy', $staff->id)); ?>" 
      method="POST" 
      class="hidden">
    <?php echo csrf_field(); ?>
...
<script>
    ...
    function confirmDelete() {
        if (confirm('Are you sure you want to delete "<?php echo e($staff->name); ?>"? This action cannot be undone.')) {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/staff/edit.blade.php ENDPATH**/ ?>
            ...
            <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6 flex flex-col items-center sm:flex-row sm:space-x-4">
                    <div class="mb-4 sm:mb-0">
                        <img id="avatar-preview" src="<?php echo e($user->avatar_url); ?>" alt="Avatar Preview"
                ...
                <div class="mb-4">
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Confirm New Password
                        (Required if changing password)</label>
                ...
                <div class="mb-6">
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="is_admin" value="1" <?php echo e(old('is_admin', $user->is_admin) ? 'checked' : ''); ?>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 border border-gray-200 rounded-lg p-4 bg-gray-50">
                        ...
                        <?php $__currentLoopData = $availablePermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="inline-flex items-center space-x-2">
                                <input type="checkbox" name="permissions[]" value="<?php echo e($perm); ?>" <?php echo e(in_array($perm, old('permissions', $userPermissions)) ? 'checked' : ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>
            ...
            <div>
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1 ml-0.5">Editing: <?php echo e($event->title); ?></p>
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8">
                <form action="<?php echo e(route('admin.events.update', $event->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="type" 
                                    ...
                                    <option value="webinar" <?php echo e(old('type', $event->type) == 'webinar' ? 'selected' : ''); ?>>Webinar</option>
                                    <option value="seminar" <?php echo e(old('type', $event->type) == 'seminar' ? 'selected' : ''); ?>>Seminar</option>
                                    <option value="networking" <?php echo e(old('type', $event->type) == 'networking' ? 'selected' : ''); ?>>Networking</option>
                                    <option value="exhibition" <?php echo e(old('type', $event->type) == 'exhibition' ? 'selected' : ''); ?>>Exhibition</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       name="date" 
                                       id="date" 
                                       value="<?php echo e(old('date', $event->date ? $event->date->format('Y-m-d') : '')); ?>"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="tag" 
                                       id="tag" 
                                       value="<?php echo e(old('tag', $event->tag)); ?>"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition"
                    ...
                    <div class="space-y-6">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <div class="relative group">
                                                <div class="h-24 w-24 bg-white border border-gray-200 rounded-lg p-3 flex items-center justify-center overflow-hidden cursor-pointer hover:ring-2 hover:ring-indigo-300 transition-all duration-200"
                                                     onclick="openImageViewer('<?php echo e($currentImage); ?>', '<?php echo e($event->title); ?>')">
                                                    <img src="<?php echo e($currentImage); ?>" 
                        ...
                        <div>
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                                <?php echo e($event->image ? 'Upload New Image (Optional)' : 'Upload Image'); ?>
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="mt-2 flex items-center space-x-3">
                                                <button type="button" 
                                                    ...
                                                    <?php echo e($event->image ? 'Remove new image' : 'Remove image'); ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" 
                                           name="seats" 
                                           id="seats" 
                                           value="<?php echo e(old('seats', $event->seats)); ?>"
                                           min="0"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition"
                                           placeholder="0">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" 
                                           name="speakers" 
                                           id="speakers" 
                                           value="<?php echo e(old('speakers', $event->speakers)); ?>"
                                           min="0"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition"
                                           placeholder="0">
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-xl p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-medium text-gray-900"><?php echo e($event->created_at->format('M d, Y')); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-600">Last Updated</span>
                        <span class="text-sm font-medium text-gray-900"><?php echo e($event->updated_at->format('M d, Y')); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-600">Featured</span>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($event->is_featured ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/events/edit.blade.php ENDPATH**/ ?>
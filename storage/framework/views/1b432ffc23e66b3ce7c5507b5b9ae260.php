<?php $__env->startSection('title', 'Add New Impact Story'); ?>
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Share the inspiring story..."><?php echo e(old('story')); ?></textarea>
                    <?php $__errorArgs = ['story'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/stories/create.blade.php ENDPATH**/ ?>
...
<div>
    <div class="relative">
        <?php if(isset($promotion) && $promotion->image): ?>
            <img 
        ...
        <div class="absolute -bottom-6 -right-6 bg-amber-500 p-6 rounded-2xl shadow-xl">
            ...
            <div>
                <?php if(isset($items) && $items->isNotEmpty()): ?>
                
                <?php if($items->first()->badge): ?>
                <span class="inline-block px-4 py-2 bg-amber-100 text-amber-700 rounded-full text-sm font-semibold mb-4">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <?php $__currentLoopData = $orderSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

...
<?php $__env->startSection('page-title', 'Database Backup'); ?>
<?php $__env->startSection('page-description', 'Create and download a full backup of your database.'); ?>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gray-50 px-8 py-4 border-t border-gray-100 text-xs text-gray-500">
                    Last backup attempted: <?php echo e(now()->format('Y-m-d H:i:s')); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/backup/index.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Create News Article'); ?>
<?php $__env->startSection('page-title', 'Create Article'); ?>
<?php $__env->startSection('page-description', 'Fill in the details below to publish a new article.'); ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" rows="3"
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition-all placeholder:text-gray-400"
                                placeholder="Short summary for previews..."><?php echo e(old('excerpt')); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="content" rows="12"
                                ...
                                placeholder="Write your article content here..."><?php echo e(old('content')); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="published_at" value="<?php echo e(old('published_at')); ?>"

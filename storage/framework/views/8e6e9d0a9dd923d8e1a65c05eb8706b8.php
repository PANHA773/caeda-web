    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-slate-900">
            <div class="absolute inset-0 opacity-30">
                <div
                    class="absolute top-20 left-10 w-72 h-72 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float">
                </div>
                <div class="absolute bottom-20 right-10 w-72 h-72 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"
                    style="animation-delay: 2s;"></div>
                <div class="absolute top-1/2 left-1/3 w-64 h-64 bg-emerald-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float"
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-20">
            <div class="text-center mb-16 animate-fade-up">
                <div
                    class="inline-flex items-center gap-3 mb-6 px-4 py-2 rounded-full glass text-white text-sm font-medium">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="#milestones"
                        class="group inline-flex items-center gap-3 bg-white text-gray-900 hover:bg-gray-100 font-semibold py-4 px-8 rounded-xl transition-all duration-300 hover:scale-105 shadow-2xl">
                        Explore Milestones
                        <i class="fas fa-arrow-down group-hover:translate-y-1 transition-transform"></i>
                    </a>
                    <a href="#stats"
                        class="group inline-flex items-center gap-3 glass border border-white/20 text-white hover:bg-white/10 font-semibold py-4 px-8 rounded-xl transition-all duration-300">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20">
                <?php $__currentLoopData = $heroStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="glass p-6 rounded-2xl text-center backdrop-blur-sm transform transition-all duration-500 hover:scale-105 animate-scale-in"
                        style="animation-delay: <?php echo e($loop->index * 0.1); ?>s;">
                        <div
                            class="<?php echo e($stat->color); ?> w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl">
                            <?php echo $stat->icon; ?>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="relative">
                ...
                <?php $__currentLoopData = $milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative mb-20 md:mb-28 flex flex-col md:flex-row
                                   <?php echo e($index % 2 == 0 ? 'md:flex-row-reverse' : ''); ?>

                                   animate-fade-up" style="animation-delay: <?php echo e($index * 0.12); ?>s;">

                        
                        <div class="hidden md:flex absolute left-1/2 top-10 transform -translate-x-1/2 z-10">
                            <span class="w-5 h-5 rounded-full border-4 border-white shadow-lg
                        ...
                        <div class="w-full md:w-1/2 px-0 md:px-10">
                            <div class="relative bg-white/80 backdrop-blur-xl rounded-3xl
                                ...
                                <div class="p-8 md:p-10">
                                    ...
                                    <?php if($milestone->achievements): ?>
                                        <div class="flex flex-wrap gap-2">
                                            <?php $__currentLoopData = $milestone->achievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $achievement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="px-4 py-1.5 rounded-full text-sm
    ...
    <section class="py-24 px-4 md:px-8 bg-gradient-to-b from-gray-900 to-slate-900 text-white">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-wrap justify-center gap-3 mb-12">
                <button
                    class="filter-btn active px-5 py-2 rounded-full bg-white text-gray-900 font-semibold transition-all duration-300 hover:scale-105"
                    data-filter="all">
                    All Awards
                </button>
                <button
                    class="filter-btn px-5 py-2 rounded-full glass border border-white/20 font-medium transition-all duration-300 hover:bg-white/10"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <?php $__currentLoopData = $awards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $award): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="award-card glass-dark p-8 rounded-2xl border border-white/10 card-hover transform transition-all duration-500 animate-scale-in"
                        data-category="<?php echo e($award->category); ?>" style="animation-delay: <?php echo e($index * 0.05); ?>s;">

                        <div class="flex justify-between items-start mb-6">
                            <div
                                class="w-14 h-14 rounded-xl bg-gradient-to-br <?php echo e($award->color); ?> flex items-center justify-center">
    ...
    <section id="stats" class="py-24 px-4 md:px-8 bg-gradient-to-b from-white to-slate-50">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <?php $__currentLoopData = $growthStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white p-6 rounded-2xl shadow-lg card-hover">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div
                                        class="flex items-center gap-1 text-<?php echo e($stat->trend == 'up' ? 'green' : 'red'); ?>-600 font-semibold">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <?php $__currentLoopData = $impactStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="text-center transform transition-all duration-500 hover:scale-105">
                        <div
                            class="<?php echo e($stat['color']); ?> w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 text-white text-2xl shadow-lg">
                    ...
                    <div class="splide__list">
                        ...
                        <?php $__currentLoopData = $successStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="splide__slide px-2">
                                <div class="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl
                                    ...
                                    <div class="p-8 md:p-10">
                                        ...
                                        <div class="flex items-center gap-5 mb-8">
                                            <div class="relative">
                                                ...
                                                <span
                                                    class="absolute -bottom-2 -right-2 w-6 h-6 rounded-full
                                        ...
                                        <div class="relative mb-10">
                                            <svg class="absolute -top-4 -left-2 w-12 h-12 text-gray-200" fill="currentColor"
                                                viewBox="0 0 24 24">
                                                <path
                                                    d="M7.17 6A5.001 5.001 0 0 0 3 11v7h7v-7H7.17zM21 11v7h-7v-7h3.17A5.001 5.001 0 0 0 21 6z" />
                                            </svg>
                                        ...
                                        <div class="flex items-center gap-3 text-sm font-semibold
                                            ...
                                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                                <path
                                                    d="M9 2a1 1 0 00-1 1v1H5a1 1 0 00-1 1v3a5 5 0 004 4.9V15H6a1 1 0 000 2h8a1 1 0 000-2h-2v-2.1A5 5 0 0016 8V5a1 1 0 00-1-1h-3V3a1 1 0 00-1-1z" />
                                            </svg>

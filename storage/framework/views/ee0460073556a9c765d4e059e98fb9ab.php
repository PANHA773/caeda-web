...
<?php $__env->startSection('title', 'Edit Workshop'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-4xl mx-auto px-6 py-8">
        ...
        <form action="<?php echo e(route('admin.workshops.update', $workshop->id)); ?>" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="text" name="title" value="<?php echo e(old('title', $workshop->title)); ?>"
            ...
            <div>
                ...
                <input type="text" name="category" value="<?php echo e(old('category', $workshop->category)); ?>"
                    class="w-full mt-1 border rounded-lg px-4 py-2" required>
            </div>
            ...
            <div>
                ...
                <?php if($workshop->instructor_image): ?>
                    <img src="<?php echo e(asset('storage/' . $workshop->instructor_image)); ?>" class="w-20 h-20 rounded-full mb-2">
                <?php endif; ?>
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                    class="w-full mt-1 border rounded-lg px-4 py-2"><?php echo e(old('description', $workshop->description)); ?></textarea>
            </div>
            ...
            <div>
                ...
                <select name="level" class="w-full mt-1 border rounded-lg px-4 py-2" required>
                    ...
                    <option value="intermediate" <?php echo e($workshop->level == 'intermediate' ? 'selected' : ''); ?>>Intermediate
                    </option>
            ...
            <div>
                ...
                <input type="url" name="video_url"
                    value="<?php echo e(old('video_url', $workshop->video && preg_match('/^https?:\/\//i', $workshop->video) ? $workshop->video : '')); ?>"
            ...
            <div>
                ...
                <?php if($workshop->video && !preg_match('/^https?:\/\//i', $workshop->video)): ?>
                    <div class="mb-2 p-2 bg-gray-50 rounded border flex items-center justify-between text-sm">
                        <span class="text-gray-600 truncate"><?php echo e(basename($workshop->video)); ?></span>
                        <a href="<?php echo e(asset('storage/' . $workshop->video)); ?>" target="_blank"
            ...
            <div>
                ...
                <?php if($workshop->image): ?>
                    <img src="<?php echo e(asset('storage/' . $workshop->image)); ?>" class="w-48 h-28 object-cover rounded-lg border mb-3">
                <?php else: ?>
            ...
            <div class="flex items-center gap-3">
                <input type="checkbox" name="status" value="1" <?php echo e(old('status', $workshop->status) ? 'checked' : ''); ?>>
                <label class="text-sm text-gray-700">Active</label>
            </div>

            
            <div class="flex justify-end gap-3">
                <a href="<?php echo e(route('admin.workshops.index')); ?>" class="px-4 py-2 border rounded-lg text-gray-700">
                    Cancel
                </a>

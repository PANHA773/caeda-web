...
<section class="py-20 px-4 md:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            <?php $__currentLoopData = $memberCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div 
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                >
                    ...
                    <?php if($plan->is_popular && $plan->badge): ?>
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10 px-4 md:px-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center mb-6 animate-fade-in-up" style="animation-delay: 800ms">
            <button onclick="startFreeTrial()"
                ...
                <span class="flex items-center">
                    <?php echo e($cta->primary_button_text); ?>
            ...
            <button onclick="scheduleDemo()"
                ...
                <span class="flex items-center">
                    <?php echo e($cta->secondary_button_text); ?>

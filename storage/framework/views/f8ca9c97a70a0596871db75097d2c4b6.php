            ...
            <div class="container mx-auto px-4 relative">
                <div class="max-w-4xl mx-auto text-center mb-12">
                    ...
                    <div
                        ...
                        <form action="<?php echo e(route('news')); ?>" method="GET" class="flex flex-col md:flex-row gap-2">
                ...
                <div class="flex flex-wrap justify-center gap-4 text-sm font-bold">
                    <a href="<?php echo e(route('news')); ?>"
                        class="px-6 py-3 rounded-full <?php echo e(!request('category') ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 border border-gray-100 hover:bg-gray-50'); ?> transition-all shadow-sm">
                        All Stories
                    </a>
                    <a href="#"
        ...
        <section class="container mx-auto px-4 pb-24">
            <div class="flex items-center justify-between mb-12 border-b border-gray-100 pb-6">
                <div>
                    ...
                    <p class="text-gray-500 mt-1">Showing <?php echo e($news->count()); ?> of <?php echo e($news->total()); ?> results</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                <?php $__empty_1 = true; $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="news-card-v2 group animate-fade-in-up" style="animation-delay: <?php echo e($index * 100); ?>ms">
                        
                        <a href="<?php echo e(route('news.show', $post->slug)); ?>" class="block relative aspect-[16/10] overflow-hidden">
                            <?php if($post->image): ?>
                        ...
                        <div class="p-8">
                            <div
                                ...
                                <span class="flex items-center">
                                    ...
                                    <?php echo e(optional($post->published_at)->format('M d, Y')); ?>

                                </span>
                                <span>•</span>
                                <span class="flex items-center">
                                    <i class="far fa-user mr-2 text-purple-500"></i>
                                    <?php echo e(data_get($post, 'user.name', 'CAEDA')); ?>
                            ...
                            <div class="flex items-center justify-between pt-6 border-t border-gray-50">
                                <div class="flex items-center space-x-6">
                                    ...
                                    <button class="flex items-center text-gray-400 font-bold group/btn">
                                        ...
                                        <span><?php echo e($post->comments); ?></span>
                                    </button>
                                </div>

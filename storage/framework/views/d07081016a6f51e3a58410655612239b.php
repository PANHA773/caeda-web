...
<div class="space-y-6">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl px-6 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
            ...
            <?php $__currentLoopData = $faculties->getUrlRange(1, $faculties->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($page == $faculties->currentPage()): ?>

...
<?php $__env->startSection('title', 'Locations & Hours'); ?>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="px-6 py-4"><?php echo e($location->title); ?></td>
                        <td class="px-6 py-4"><?php echo Str::limit($location->description, 50); ?></td>
                        <td class="px-6 py-4">
                            <i class="<?php echo e($location->icon); ?>"></i> <?php echo e($location->icon); ?>

                        </td>
                        <td class="px-6 py-4"><?php echo e($location->order ?? '-'); ?></td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-center space-x-2">
                            ...
                            <form action="<?php echo e(route('admin.locations.destroy', $location->id)); ?>" method="POST" class="inline-block"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/locations/index.blade.php ENDPATH**/ ?>
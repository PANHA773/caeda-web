...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30 py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
                ...
                <div class="group bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 hover:shadow-2xl transition-transform duration-500 hover:-translate-y-3"
                    ...
                    <div class="flex flex-col items-center text-center gap-4">
                        ...
                        <div class="w-36 h-36 rounded-2xl overflow-hidden relative flex items-center justify-center shadow-lg transform transition-all duration-500 group-hover:scale-105 group-hover:rotate-3">
                            ...
                            <?php if($imagePath): ?>
                            <img src="<?php echo e($imagePath); ?>" alt="<?php echo e($leader->name); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                            <div class="w-full h-full bg-gradient-to-br <?php echo e($leader->gradient ?? 'from-blue-500 to-indigo-600'); ?> flex items-center justify-center text-white text-2xl font-bold">
                                <?php echo e($initials); ?>
        ...
        <?php if($projectOverviews->count()): ?>
        <?php $__currentLoopData = $projectOverviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $overview): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div data-animate
...
<div data-animate
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        ...
        <?php $__currentLoopData = $managers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                // Initials fallback
                ...
                <div class="w-28 h-28 md:w-32 md:h-32 rounded-2xl overflow-hidden mx-auto mb-3 relative shadow-md">
                    ...
                    <?php else: ?>
                        <div class="w-full h-full flex items-center justify-center
                                    bg-gradient-to-br <?php echo e($member->gradient ?? 'from-green-500 to-teal-600'); ?>
        ...
        <div data-animate class="bg-gradient-to-br from-blue-50/80 to-indigo-50/80 backdrop-blur-sm rounded-3xl p-8 md:p-10 mb-16 border border-blue-200/50 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                ...
                <?php $__currentLoopData = $staffMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="group bg-white/90 backdrop-blur-sm rounded-xl p-4 text-center border border-gray-200/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 cursor-pointer"
                    ...
                    <!-- <div class="w-24 h-24 rounded-[15px] overflow-hidden mx-auto mb-3 relative"> -->
                        ...
                        <?php if($member->image && file_exists(public_path('storage/' . $member->image))): ?>
        ...
        <div data-animate class="grid md:grid-cols-2 gap-8 mb-16">
            <?php $__currentLoopData = $visionMissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div data-animate class="mb-16">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        <?php $__currentLoopData = $goals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        <?php $__currentLoopData = $strategies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $strategy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 hover:shadow-xl transition-all duration-500 hover:-translate-y-2"
                            style="animation-delay: <?php echo e($index * 100); ?>ms">
                            <div class="flex items-start space-x-4">
                                <div class="text-3xl transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-12">
        ...
        <div data-animate
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                <?php $__empty_1 = true; $__currentLoopData = $valuesBenefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

...
@section('title', 'Add New Feature - Admin CAEDA')
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8 animate-fade-in-up flex justify-between items-start">
            <div>
                <a href="{{ route('admin.features.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 mb-2">
                ...
                <div class="form-card animate-slide-in-right">
                    <form action="{{ route('admin.features.store') }}" method="POST" id="featureForm">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="title" id="title" maxlength="50" value="{{ old('title') }}"
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="3" maxlength="200" class="form-input resize-none" placeholder="Describe the feature">{{ old('description') }}</textarea>
                        ...
                        <div class="mb-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="icon" id="icon" value="{{ old('icon', 'fas fa-star') }}" class="form-input" placeholder="fas fa-star">
                                    <div class="mt-4 flex items-center space-x-3">
                                        <div class="icon-preview" id="iconPreview"><i class="{{ old('icon', 'fas fa-star') }}"></i></div>
                                        <span class="text-sm text-gray-600">Icon Preview</span>
                                    </div>
                                </div>
                                <div>
                                    <label for="color" class="form-label">Color Gradient *</label>
                                    <input type="text" name="color" id="color" value="{{ old('color','from-blue-500 to-cyan-500') }}" class="form-input" placeholder="from-blue-500 to-cyan-500">
                                    <div class="mt-4 flex items-center space-x-3">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order',0) }}" min="0" max="999" class="form-input">
                                </div>
                                <div class="space-y-4">
                                    ...
                                    <label class="flex items-center space-x-3 cursor-pointer">
                                        <input type="checkbox" name="is_popular" value="1" {{ old('is_popular')?'checked':'' }} class="form-checkbox">
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                            <a href="{{ route('admin.features.index') }}" class="cancel-btn">Cancel</a>

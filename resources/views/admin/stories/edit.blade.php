            ...
            <form action="{{ route('admin.stories.update', $story->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-8 p-4 bg-gray-50 rounded-xl">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <a href="{{ asset('storage/' . $story->image) }}" target="_blank"
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @if(file_exists($imagePath))
                                    <span class="text-sm text-gray-500">
                                        {{ round(filesize($imagePath) / 1024) }} KB
                                    </span>
                                @endif
                            </div>
                        </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="story" 
                              ...
                              placeholder="Share the inspiring story...">{{ old('story', $story->story) }}</textarea>
                    @error('story')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                        {{ $story->image ? 'Replace Image' : 'Upload Image' }}
                    </label>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-400 transition-colors
                        ...
                        <div id="upload-area" onclick="document.getElementById('image').click()" class="cursor-pointer">
                            ...
                            <p class="text-gray-600 mb-1">Click to upload {{ $story->image ? 'a new image' : 'an image' }}</p>

...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-500">Update the details of "{{ $staff->name }}"</p>
    </div>
            ...
            <div class="mt-8 p-4 bg-gray-50 rounded-xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="p-3 bg-white rounded-lg">
                        ...
                        <p class="text-sm font-medium text-gray-900">{{ $staff->id }}</p>
                    </div>
                    <div class="p-3 bg-white rounded-lg">
                        <p class="text-xs text-gray-500">Created</p>
                        <p class="text-sm text-gray-900">{{ $staff->created_at->format('M d, Y') }}</p>
                    </div>
                    <div class="p-3 bg-white rounded-lg">
                        <p class="text-xs text-gray-500">Last Updated</p>
                        <p class="text-sm text-gray-900">{{ $staff->updated_at->format('M d, Y') }}</p>
                    </div>
                </div>
            </div>

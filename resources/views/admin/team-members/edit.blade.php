                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="bio" 
                                  ...
                                  placeholder="Enter member's bio or description...">{{ old('bio', $teamMember->bio) }}</textarea>
                ...
                <div class="space-y-6">
                    ...
                    <div class="pt-4">
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                            <div class="flex items-center gap-3">
                                <div class="p-2 {{ $teamMember->is_active ? 'bg-green-100' : 'bg-gray-100' }} rounded-lg">
...
<form id="deleteForm" 
      action="{{ route('admin.team-members.destroy', $teamMember->id) }}" 
      method="POST" 
      class="hidden">
    @csrf
    @method('DELETE')
...
<script>
    ...
    function confirmDelete() {
        if (confirm('Are you sure you want to delete {{ $teamMember->name }}? This action cannot be undone.')) {

...
@section('title', 'Add Featured Event')
...
<div class="container mx-auto p-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.featured_events.store') }}" method="POST">
            @csrf

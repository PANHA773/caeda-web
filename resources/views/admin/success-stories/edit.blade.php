            ...
            <form action="{{ route('admin.success-stories.update', $successStory->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $successStory->name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="role" id="role" value="{{ old('role', $successStory->role) }}"
                            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                            required>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="achievement" id="achievement" rows="3"
                            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                            required>{{ old('achievement', $successStory->achievement) }}</textarea>
                    </div>

                    {{-- Image --}}
                    <div>
                        <label for="image" class="block text-gray-700 font-medium mb-1">Update Photo</label>
                        @if($successStory->image)
                            <div class="mb-2">
                                <img src="{{ $successStory->image_url }}" alt="Current Photo"
                    ...
                    <div>
                        ...
                        <input type="text" name="year" id="year" value="{{ old('year', $successStory->year) }}"
                            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="quote" id="quote" rows="4"
                            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                            required>{{ old('quote', $successStory->quote) }}</textarea>
                    </div>

                    {{-- Order --}}
                    <div>
                        <label for="order" class="block text-gray-700 font-medium mb-1">Order</label>
                        <input type="number" name="order" id="order" value="{{ old('order', $successStory->order) }}"
                            class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                            min="1">
                    </div>

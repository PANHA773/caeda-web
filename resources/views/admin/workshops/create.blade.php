    ...
    <div class="max-w-4xl mx-auto px-6 py-8">
        ...
        <form action="{{ route('admin.workshops.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" class="w-full mt-1 border rounded-lg px-4 py-2"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="category" value="{{ old('category') }}"
                    class="w-full mt-1 border rounded-lg px-4 py-2" placeholder="Design, Development..." required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="duration" value="{{ old('duration') }}"
                    class="w-full mt-1 border rounded-lg px-4 py-2" placeholder="e.g., 2h 30m">
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Supported formats: MP4, MOV, OGG (Max 20MB)</p>
            </div>

            {{-- Thumbnail --}}
            <div>
                <label class="block text-sm font-medium text-gray-700">Thumbnail</label>
                <input type="file" name="image" class="w-full mt-1 border rounded-lg px-4 py-2" accept="image/*" required>
            </div>

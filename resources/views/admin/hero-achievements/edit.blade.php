...
@section('title', 'Edit Hero Achievement')
...
<div class="p-6">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        <form action="{{ route('admin.hero-achievements.update', $heroAchievement->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title"
                           ...
                           value="{{ old('title', $heroAchievement->title) }}" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="value" id="value"
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-indigo-200"
                           value="{{ old('value', $heroAchievement->value) }}" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="icon" id="icon"
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-indigo-200"
                           value="{{ old('icon', $heroAchievement->icon) }}">
                ...
                <div>
                    ...
                    <input type="number" name="order" id="order"
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-indigo-200"
                           value="{{ old('order', $heroAchievement->order) }}" min="1">
                </div>

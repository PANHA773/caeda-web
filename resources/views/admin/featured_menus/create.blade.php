...
<div class="p-6 max-w-5xl mx-auto">
    ...
    <!-- Form -->
    <form action="{{ route('admin.featured_menus.store') }}"
          method="POST"
        ...
        <div>
            ...
            <textarea name="description" rows="3"
                      class="w-full rounded-lg border-gray-300 focus:ring-amber-500 focus:border-amber-500"
                      placeholder="Short description of the drink">{{ old('description') }}</textarea>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="number" name="reviews" value="{{ old('reviews', 0) }}"
                       class="w-full rounded-lg border-gray-300 focus:ring-amber-500 focus:border-amber-500">
            </div>

{{-- resources/views/admin/contact-information/edit.blade.php --}}
    ...
    <form action="{{ route('admin.contact-information.update', $contact->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="icon" id="icon"
                   class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                   value="{{ old('icon', $contact->icon) }}" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="color" id="color"
                   class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                   value="{{ old('color', $contact->color) }}" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="action" id="action"
                   class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                   value="{{ old('action', $contact->action) }}">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="action_icon" id="action_icon"
                   class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                   value="{{ old('action_icon', $contact->action_icon) }}">

            ...
            <div>
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1 ml-0.5">Editing: {{ $partner->name }}</p>
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8">
                <form action="{{ route('admin.partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="logo" class="block text-sm font-medium text-gray-700 mb-2">
                                {{ $partner->logo ? 'Upload New Logo (Optional)' : 'Upload Logo' }}
                            </label>
                                ...
                                <div class="flex items-center space-x-6">
                                    ...
                                    <label class="flex items-center">
                                        <input type="radio" 
                                               name="is_active" 
                                               value="0" 
                                               {{ old('is_active', $partner->is_active) == 0 ? 'checked' : '' }}
                                               class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-xl p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-medium text-gray-900">{{ $partner->created_at->format('M d, Y') }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-600">Last Updated</span>
                        <span class="text-sm font-medium text-gray-900">{{ $partner->updated_at->format('M d, Y') }}</span>
                    </div>
                    <div class="flex items-center justify-between">

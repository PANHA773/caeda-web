...
@section('page-title', 'Add New Hero Section')
@section('page-description', 'Create a new hero section for your website.')
...
<div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow">
    <form action="{{ route('admin.heroes.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="highlight_title" id="highlight_title" value="{{ old('highlight_title') }}"
                   class="w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300">
        ...
        <div class="mb-4">
            ...
            <textarea name="subtitle" id="subtitle" rows="3"
                      class="w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300">{{ old('subtitle') }}</textarea>

                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="type"
                                    ...
                                    <option value="vision" {{ old('type') == 'vision' ? 'selected' : '' }}>Vision Statement</option>
                                    <option value="mission" {{ old('type') == 'mission' ? 'selected' : '' }}>Mission Statement</option>
                                </select>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                      ...
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white hover:border-gray-400">{{ old('description') }}</textarea>

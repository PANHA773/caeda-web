    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
        ...
        <div class="flex items-center space-x-4 mt-4 md:mt-0">
            ...
            <div class="bg-green-50 px-4 py-3 rounded-lg">
                ...
                <p class="text-2xl font-bold text-gray-800">{{ $todayCount ?? 0 }}</p>
            </div>
        </div>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($contacts as $contact)
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg flex items-center justify-center">
                                        <span class="text-blue-600 font-semibold">{{ strtoupper(substr($contact->name, 0, 1)) }}</span>
                                    </div>
                                    <div class="ml-4">
                            ...
                            <!-- Newsletter Status -->
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $contact->newsletter ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-sm text-gray-500">{{ $contact->created_at->format('h:i A') }}</div>
                            </td>
            ...
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        ...
                        <span class="font-medium">{{ $contacts->total() }}</span> results
                    </div>

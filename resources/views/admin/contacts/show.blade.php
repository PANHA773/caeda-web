            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex items-start mb-6">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-12 w-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-md">
                                <span class="text-white font-bold text-lg">{{ strtoupper(substr($contact->name, 0, 1)) }}</span>
                            </div>
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-xl p-5">
                        <div class="text-gray-700 whitespace-pre-wrap leading-relaxed">{{ $contact->message }}</div>
                    </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <div class="flex items-center text-sm text-gray-600">
                            ...
                            <span>Sent on {{ $contact->created_at->format('F j, Y') }} at {{ $contact->created_at->format('g:i A') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    ...
                                    <a href="mailto:{{ $contact->email }}" class="font-medium text-blue-600 hover:text-blue-800">{{ $contact->email }}</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    ...
                                    <span class="font-medium text-gray-900">{{ $contact->phone ?? 'Not provided' }}</span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    <svg class="w-5 h-5 mr-3 {{ $contact->newsletter ? 'text-green-500' : 'text-gray-400' }}" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                    </svg>
                                    <span class="font-medium text-gray-900">{{ $contact->newsletter ? 'Subscribed to newsletter' : 'Not subscribed to newsletter' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        <a href="mailto:{{ $contact->email }}" 
                           class="flex items-center w-full px-4 py-3 text-left bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg transition-colors group">
                            ...
                            <span class="font-medium">Reply to {{ $contact->name }}</span>
                        </a>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="font-mono text-sm bg-gray-50 p-2 rounded border border-gray-200">{{ $contact->id }}</div>
                        </div>

...
@section('title', 'Edit Program - Admin CAEDA')
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8 animate-fade-in-up">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Update program details for {{ $program->title }}</p>
                </div>
        ...
        <form action="{{ route('admin.programs.update', $program->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8" id="programForm">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="form-group">
                                        ...
                                        <select id="category" 
                                            ...
                                            <option value="Business" {{ old('category', $program->category) == 'Business' ? 'selected' : '' }}>Business</option>
                                            <option value="Science" {{ old('category', $program->category) == 'Science' ? 'selected' : '' }}>Science</option>
                                            <option value="Arts" {{ old('category', $program->category) == 'Arts' ? 'selected' : '' }}>Arts</option>
                                            <option value="Health" {{ old('category', $program->category) == 'Health' ? 'selected' : '' }}>Health</option>
                                            <option value="Engineering" {{ old('category', $program->category) == 'Engineering' ? 'selected' : '' }}>Engineering</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="level" 
                                            ...
                                            <option value="expert" {{ old('level', $program->level) == 'expert' ? 'selected' : '' }}>Expert</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="short_description" 
                                              ...
                                              placeholder="Brief overview of the program">{{ old('short_description', $program->short_description) }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('application_deadline', optional($program->application_deadline)->format('Y-m-d')) }}"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" 
                                           id="students" 
                                           name="students" 
                                           value="{{ old('students', $program->students) }}"
                                           min="0"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                    <p class="text-gray-500 text-sm mt-2">Current: {{ $program->students }} students</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section p-6 bg-white rounded-xl border border-gray-200">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" 
                                          ...
                                          placeholder="Detailed description including curriculum, learning outcomes, prerequisites...">{{ old('description', $program->description) }}</textarea>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="form-section p-6 bg-white rounded-xl border border-gray-200">
                            ...
                            <input type="hidden" id="final_price" name="final_price" value="{{ old('final_price', $program->final_price) }}">
                                ...
                                <div class="form-group price-input">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               id="tuition" 
                                               name="tuition" 
                                               value="{{ old('tuition', $program->tuition) }}"
                                               required
                                               step="0.01"
                                               min="0"
                                ...
                                <div class="form-group price-input">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               id="discount" 
                                               name="discount" 
                                               value="{{ old('discount', $program->discount) }}"
                                               step="0.01"
                                               min="0"
                                               class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                                ...
                                <div id="price-summary" class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200">
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span id="tuition-summary" class="font-medium">${{ number_format($program->tuition, 2) }}</span>
                                        </div>
                                        <div id="discount-row" class="flex justify-between items-center {{ $program->has_discount ? '' : 'hidden' }}">
                                            <span class="text-gray-600">Discount:</span>
                                            <span id="discount-summary" class="font-medium text-green-600">-{{ $program->has_discount ? '$' . number_format($program->tuition - $program->final_price, 2) : '$0.00' }}</span>
                                        </div>
                                        <div class="border-t border-blue-200 pt-2 mt-2 flex justify-between items-center">
                                            ...
                                            <span id="final-price-summary" class="text-xl font-bold text-blue-700">${{ number_format($program->final_price, 2) }}</span>
                                        </div>
                                    </div>
                                </div>
                                
                                <div id="savings-calc" class="{{ $program->has_discount ? '' : 'hidden' }} p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-sm text-gray-600">Students save</p>
                                            <p class="text-2xl font-bold text-green-700" id="savings-amount">
                                                {{ $program->has_discount ? '$' . number_format($program->tuition - $program->final_price, 2) : '$0' }}
                                            </p>
                                        </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="badge_color" 
                                        ...
                                        <option value="bg-blue-600" {{ old('badge_color', $program->badge_color) == 'bg-blue-600' ? 'selected' : '' }}>Blue</option>
                                        <option value="bg-red-600" {{ old('badge_color', $program->badge_color) == 'bg-red-600' ? 'selected' : '' }}>Red</option>
                                        <option value="bg-green-600" {{ old('badge_color', $program->badge_color) == 'bg-green-600' ? 'selected' : '' }}>Green</option>
                                        <option value="bg-yellow-600" {{ old('badge_color', $program->badge_color) == 'bg-yellow-600' ? 'selected' : '' }}>Yellow</option>
                                        <option value="bg-purple-600" {{ old('badge_color', $program->badge_color) == 'bg-purple-600' ? 'selected' : '' }}>Purple</option>
                                        <option value="bg-pink-600" {{ old('badge_color', $program->badge_color) == 'bg-pink-600' ? 'selected' : '' }}>Pink</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section p-6 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl border border-indigo-200">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-medium">{{ $program->created_at->format('M d, Y') }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Last Updated:</span>
                                    <span class="font-medium">{{ $program->updated_at->format('M d, Y') }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Program ID:</span>
                                    <span class="font-mono text-sm">{{ $program->id }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Slug:</span>
                                    <span class="font-mono text-sm truncate max-w-[150px]">{{ $program->slug }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Current Rating:</span>
                                    <span class="font-medium">{{ number_format($program->rating, 1) }} ⭐</span>
                                </div>
                            </div>
                        </div>
                    </div>

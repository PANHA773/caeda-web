        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <div class="flex items-center space-x-3">
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Create New Event</h1>
                </div>
                <p class="text-gray-600 mt-2 ml-8">Fill in the details below to add a new event</p>
            </div>
    ...
    <div class="max-w-5xl mx-auto">
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Enter the event details below</p>
                    </div>
                </div>
            </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="relative group">
                                        <div id="image-preview-container" class="h-24 w-24 bg-white border border-gray-200 rounded-lg p-3 flex items-center justify-center overflow-hidden cursor-pointer hover:ring-2 hover:ring-indigo-300 transition-all duration-200"
                                             onclick="openImageViewer(document.getElementById('image-preview-image').src, 'Event Image Preview')">
        ...
        <div class="mt-6 bg-blue-50 border border-blue-100 rounded-xl p-6">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-sm font-medium text-blue-900 mb-2">Tips for creating events</h3>
                    <ul class="text-sm text-blue-800 space-y-1 list-disc list-inside">
                        <li>Upload a high-quality event image for better visual appeal</li>
                        <li>Add a descriptive tag to help categorize your event</li>
                        <li>Specify the number of seats to manage event capacity</li>
                        <li>Set featured events to highlight them on the website</li>
                        <li>Include detailed description to inform attendees</li>
                        <li>Add speakers information to attract more participants</li>
                    </ul>
                </div>
            </div>
        </div>

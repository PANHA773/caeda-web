...
@section('content')
    ...
    <section
        ...
        <div class="absolute inset-0 -z-10 overflow-hidden">
            ...
            <div
                class="absolute -bottom-40 -left-32 w-80 h-80 bg-purple-200/20 rounded-full blur-3xl animate-pulse-slow delay-1000">
            </div>
            <div
                class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-cyan-200/10 rounded-full blur-3xl animate-pulse-slow delay-500">
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="text-center">
                <div
                    class="inline-flex items-center gap-3 bg-white/20 backdrop-blur-lg px-6 py-3 rounded-full shadow-lg border border-white/50 mb-6 animate-slide-in-left">
                    <div class="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
                    <span class="text-white font-semibold text-sm md:text-base uppercase tracking-wider">INTERACTIVE
                        LEARNING • PSBU-VISON</span>
                </div>

                <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 font-cinzel">
                    <span
                        class="block animate-gradient-x bg-gradient-to-r from-cyan-300 via-blue-300 to-purple-300 bg-clip-text text-transparent">
                        PSBU-Workshop
                    </span>
                ...
                <p
                    class="text-xl md:text-2xl text-blue-100 mb-10 max-w-3xl mx-auto leading-relaxed glass-effect p-6 rounded-2xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center animate-slide-in-right">
                    <button onclick="scrollToWorkshops()"
                    ...
                    <button onclick="scrollToUpcoming()"
            ...
            <div class="flex flex-wrap justify-center gap-4">
                ...
                @foreach($categories as $index => $category)
                    <button data-category="{{ $category['id'] }}"
                        ...
                        <span
                            class="text-xl mr-3 transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-12">
                            {{ $category['icon'] }}
                        </span>
                        {{ $category['name'] }}
                        @if($category['id'] == 'all')
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @forelse($workshops as $index => $workshop)
                    <div data-category="{{ $workshop->category }}"
                        ...
                        <div class="relative h-48 bg-gray-900 overflow-hidden">
                            ...
                            {{-- Thumbnail --}}
                            <img id="thumb-{{ $workshop->id }}" src="{{ $workshop->image_url }}" alt="{{ $workshop->title }}"
                            ...
                            {{-- Badges --}}
                            <div
                                class="absolute top-4 right-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xs font-semibold px-3 py-2 rounded-xl">
                                {{ $workshop->level }}
                            </div>

                            <div
                                class="absolute top-4 left-4 bg-white/90 text-blue-600 text-xs font-semibold px-3 py-2 rounded-xl">
                                {{ $workshop->duration }}
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center mb-4 p-3 bg-gray-50 rounded-xl">
                                <img src="{{ $workshop->instructor_image_url }}"
    ...
    <section id="upcoming-workshops"
        class="py-20 bg-gradient-to-r from-blue-50/80 to-purple-50/80 backdrop-blur-sm px-4 md:px-8">
        <div class="max-w-7xl mx-auto">
            <div class="glass-effect rounded-3xl p-8 md:p-12 border border-blue-200/50 shadow-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    @foreach($upcomingWorkshops as $index => $workshop)
                        <div class="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-white/50 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 group animate-fade-in-up"
                            ...
                            <div class="flex items-start space-x-4">
                                <div class="relative flex-shrink-0">
                                    ...
                                    <div
                                        class="absolute -bottom-2 -right-2 w-6 h-6 bg-gradient-to-r from-green-400 to-green-500 rounded-full border-2 border-white shadow-lg animate-pulse">
                                    </div>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <h3
                                        class="text-lg font-bold text-gray-900 mb-2 leading-tight group-hover:text-blue-600 transition-colors duration-300">
                                        {{ $workshop->title }}
                                    </h3>
                                    <div class="flex items-center mb-3">
                                        <div
                                            class="relative w-6 h-6 rounded-full overflow-hidden border border-white shadow-sm instructor-image mr-2">
                                            <img src="{{ $workshop->instructor_image }}" alt="{{ $workshop->instructor }}"
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @forelse($testimonials as $index => $testimonial)
                    ...
                    <div class="group glass-effect rounded-3xl p-6 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 animate-fade-in-up"
                        style="animation-delay: {{ $index * 150 }}ms">
                        {{-- User Info --}}
                        <div class="flex items-center mb-6">
                            <div
                                class="relative w-14 h-14 rounded-full overflow-hidden border-4 border-white shadow-lg mr-4 transform transition-all duration-500 group-hover:scale-110">
                                <img src="{{ $testimonial->avatar ?: asset('images/avatar-placeholder.png') }}"
                        ...
                        {{-- Quote --}}
                        <p
                            class="text-gray-600 italic mb-4 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                            “{{ $testimonial->quote }}”
                        </p>
    ...
    <section class="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 text-white relative overflow-hidden">
        <div class="absolute inset-0">
            ...
            <div class="absolute -bottom-20 -left-20 w-40 h-40 bg-white/10 rounded-full blur-2xl animate-float"
        ...
        <div class="max-w-4xl mx-auto text-center relative z-10 px-4 md:px-8">
            ...
            <p class="text-blue-100 text-lg mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in-up"
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up" style="animation-delay: 400ms">
                <button onclick="scrollToWorkshops()"
                    class="group bg-white text-blue-600 hover:bg-gray-100 font-bold py-4 px-8 rounded-2xl transition-all duration-500 transform hover:scale-105 hover:shadow-2xl shadow-lg">
                ...
                <button onclick="contactCoordinator()"
                    class="group border-2 border-white text-white hover:bg-white/10 font-bold py-4 px-8 rounded-2xl transition-all duration-500 transform hover:scale-105">
                    <span class="flex items-center gap-2">
                        Contact Coordinator
        ...
        <div class="relative w-full max-w-4xl animate-scale-in">
            ...
            <div class="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <div class="aspect-w-16 aspect-h-9">
                    <iframe id="workshop-video-frame" class="w-full h-full" frameborder="0"

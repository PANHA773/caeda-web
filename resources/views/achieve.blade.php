...
@section('title', 'Our Achievements - CAEDA')
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20">
                @foreach($heroStats as $stat)
                    <div class="glass p-6 rounded-2xl text-center backdrop-blur-sm transform transition-all duration-500 hover:scale-105 animate-scale-in"
                        ...
                        <div
                            class="{{ $stat->color }} w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl">
                            {!! $stat->icon !!}
                        </div>
            ...
            <div class="relative">
                ...
                @foreach($milestones as $index => $milestone)
                    <div class="relative mb-20 md:mb-28 flex flex-col md:flex-row
                                   ...
                                   animate-fade-up" style="animation-delay: {{ $index * 0.12 }}s;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @foreach($awards as $index => $award)
                    <div class="award-card glass-dark p-8 rounded-2xl border border-white/10 card-hover transform transition-all duration-500 animate-scale-in"
                        data-category="{{ $award->category }}" style="animation-delay: {{ $index * 0.05 }}s;">

                        <div class="flex justify-between items-start mb-6">
                            <div
                                class="w-14 h-14 rounded-xl bg-gradient-to-br {{ $award->color }} flex items-center justify-center">
                        ...
                        @foreach($growthStats as $stat)
                            <div class="bg-white p-6 rounded-2xl shadow-lg card-hover">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div
                                        class="flex items-center gap-1 text-{{ $stat->trend == 'up' ? 'green' : 'red' }}-600 font-semibold">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                @foreach($impactStats as $stat)
                    <div class="text-center transform transition-all duration-500 hover:scale-105">
                        <div
                            class="{{ $stat['color'] }} w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 text-white text-2xl shadow-lg">

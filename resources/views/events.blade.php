...
<section class="py-20 px-4 md:px-8 bg-white">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mt-12">
            <a href="{{ route('speakers.index') }}" class="bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 text-gray-800 font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl inline-block">
                View All Speakers
            </a>
        </div>
    </div>

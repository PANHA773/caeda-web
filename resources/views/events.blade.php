            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-10">
                <div class="lg:w-1/2">
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                        Annual <span class="text-gradient">Tech Innovation</span> Summit 2024
                    </h2>
                    <p class="text-gray-600 mb-6 text-lg">
                        Join 1000+ tech leaders, innovators, and entrepreneurs for 3 days of groundbreaking talks, workshops, and networking.
                    </p>
                    ...
                    <div class="flex flex-wrap gap-4 mb-8">
                        <div class="flex items-center text-gray-700">
                            ...
                            <span>Convention Center, Phnom Penh</span>
                        </div>
                        <div class="flex items-center text-gray-700">
                            <svg class="w-5 h-5 text-purple-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span>Dec 15-17, 2024 • 9:00 AM - 6:00 PM</span>
                        </div>
                    </div>
...
<section class="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 px-4 md:px-8">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16 animate-fade-in-up">
            ...
            <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                Plan your year with our comprehensive event calendar. Never miss an important event again.
            </p>
        </div>
            ...
            <div class="lg:col-span-2">
                <div class="glass-effect rounded-3xl p-8 shadow-2xl">
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-2xl font-bold text-gray-900">December 2024</h3>
                    ...
                    <div class="grid grid-cols-7 gap-2 mb-4">
                        ...
                        @foreach($calendarDays as $index => $calendarDay)
                            <div class="text-center">
                                @if($calendarDay['day'])
                                    <div class="relative">
                                        <div class="calendar-day {{ $calendarDay['active'] ? 'calendar-day-active' : 'bg-white hover:bg-gray-50' }} rounded-xl p-3 cursor-pointer transition-all duration-300 {{ $calendarDay['event'] ? 'border-2 border-blue-200' : '' }}">
                                            <div class="text-lg font-bold {{ $calendarDay['active'] ? 'text-white' : 'text-gray-900' }}">
                                                {{ $calendarDay['day'] }}
                                            </div>
            ...
            <div class="lg:col-span-1">
                <div class="glass-effect rounded-3xl p-8 shadow-2xl h-full">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <button class="w-full bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 text-gray-800 font-medium py-3 rounded-xl transition-all duration-300">
                            <i class="fas fa-download mr-2"></i> Download Calendar (ICS)
                        </button>
                    </div>
                </div>
            </div>
            ...
            @foreach($speakers as $index => $speaker)
                <div class="group text-center animate-fade-in-up" style="animation-delay: {{ $index * 200 }}ms">
                    ...
                    <div class="flex justify-center space-x-3">
                        @foreach($speaker['social'] as $platform)
                ...
                @php
                    $timelineEvents = [
                        ...
                        [
                            ...
                            'description' => 'Regular pricing begins after early bird period.',
                            'status' => 'upcoming',
                        ...
                        [
                            ...
                            'description' => 'Recordings and presentation slides available for attendees.',
                            'status' => 'upcoming',

            ...
            @foreach($workshops as $index => $workshop)
                ...
                >
                    ...
                    <div class="video-container relative h-48 bg-gray-900 overflow-hidden">
                        <div id="video-player-{{ $workshop['id'] }}" class="hidden w-full h-full">
                            <iframe
                                src="{{ $workshop['video'] }}?autoplay=1"
                                class="w-full h-full"
                                frameborder="0"
                        ...
                        <button
                            onclick="playWorkshopVideo({{ $workshop['id'] }})"
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="flex items-center text-sm text-gray-500">
                                ...
                                <span class="font-semibold text-gray-900">{{ $workshop['rating'] }}</span>
                                <span class="text-gray-500 ml-1">({{ $workshop['attendees'] }})</span>
                            </div>
                        </div>

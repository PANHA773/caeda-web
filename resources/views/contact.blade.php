            ...
            <div class="space-y-8 animate-fade-in-up" style="animation-delay: 200ms">
                ...
                <div class="glass-effect rounded-3xl p-8 shadow-2xl">
                    ...
                    <div class="space-y-6">
                        ...
                        @foreach($contactMethods as $contact)
                            <div class="contact-card-hover bg-white/50 p-6 rounded-2xl border border-gray-200 hover:border-transparent transition-all duration-300 group">
                                ...
                                <button onclick="contactAction('{{ strtolower($contact['title']) }}')" 
                                    ...
                                    <i class="{{ $contact['actionIcon'] }} mr-2"></i>
                                    {{ $contact['action'] }}
                                </button>
                            </div>
                        @endforeach
                ...
                <div class="glass-effect rounded-3xl p-8 shadow-2xl">
                    ...
                    <p class="text-gray-600 mb-6">Follow us on social media for updates, news, and announcements.</p>
                    
                    <div class="flex flex-wrap gap-4">
                        @php
                            $socialPlatforms = [
                                ['platform' => 'facebook', 'icon' => 'fab fa-facebook-f', 'color' => 'bg-blue-600 hover:bg-blue-700', 'link' => '#'],
                                ['platform' => 'twitter', 'icon' => 'fab fa-twitter', 'color' => 'bg-sky-500 hover:bg-sky-600', 'link' => '#'],
                                ['platform' => 'instagram', 'icon' => 'fab fa-instagram', 'color' => 'bg-pink-600 hover:bg-pink-700', 'link' => '#'],
                                ['platform' => 'linkedin', 'icon' => 'fab fa-linkedin-in', 'color' => 'bg-blue-700 hover:bg-blue-800', 'link' => '#'],
                                ['platform' => 'youtube', 'icon' => 'fab fa-youtube', 'color' => 'bg-red-600 hover:bg-red-700', 'link' => '#'],
                                ['platform' => 'telegram', 'icon' => 'fab fa-telegram', 'color' => 'bg-blue-500 hover:bg-blue-600', 'link' => '#'],
                            ];
                        @endphp
                        ...
                        @foreach($socialPlatforms as $social)
                            <a href="{{ $social['link'] }}" 
                               target="_blank"
                               class="w-14 h-14 {{ $social['color'] }} rounded-xl flex items-center justify-center text-white transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                @php
                    $faqsLeft = [
                        [
                            ...
                            'answer' => 'You can apply online through our admissions portal, visit our campus in person, or contact our admissions team for assistance. The application process typically takes 2-3 weeks.',
                            'icon' => 'fas fa-graduation-cap',
                            'color' => 'blue'
                        ],
                        [
                            'question' => 'What are the entry requirements?',
                            'answer' => 'Requirements vary by program. Generally, you need a high school diploma or equivalent, English proficiency test scores (if applicable), and a completed application form.',
                            'icon' => 'fas fa-file-alt',
                            'color' => 'purple'
                        ],
                        [
                            'question' => 'Do you offer scholarships?',
                            'answer' => 'Yes, we offer merit-based and need-based scholarships. Applications are evaluated quarterly. Check our scholarships page for current opportunities.',
                            'icon' => 'fas fa-award',
                            'color' => 'green'
                        ],
                        [
                            'question' => 'Can international students apply?',
                            'answer' => 'Absolutely! We welcome international students and provide visa assistance, accommodation support, and orientation programs.',
                            'icon' => 'fas fa-globe',
                            'color' => 'orange'
                        ]
                    ];
            ...
            <div class="space-y-6">
                @php
                    $faqsRight = [
                        [
                            ...
                            'answer' => 'We accept credit/debit cards, bank transfers, mobile payments, and installment plans. All payments are secure and encrypted.',
                            'icon' => 'fas fa-credit-card',
                            'color' => 'purple'
                        ],
                        [
                            'question' => 'Do you provide career support?',
                            'answer' => 'Yes, our career services include resume building, interview preparation, job placement assistance, and networking events with industry partners.',
                            'icon' => 'fas fa-briefcase',
                            'color' => 'blue'
                        ],
                        [
                            'question' => 'Can I transfer credits from another institution?',
                            'answer' => 'Credit transfers are evaluated on a case-by-case basis. Submit your transcripts for review by our academic department.',
                            'icon' => 'fas fa-exchange-alt',
                            'color' => 'green'
                        ],
                        [
                            'question' => 'What technical support is available?',
                            'answer' => '24/7 technical support for online learning platforms, with dedicated support teams for different time zones.',
                            'icon' => 'fas fa-headset',
                            'color' => 'orange'
                        ]
                    ];
                ...
                @foreach($faqsRight as $index => $faq)
                    <div class="faq-item bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 cursor-pointer animate-fade-in-up" style="animation-delay: {{ ($index + 4) * 100 }}ms">
                        <div class="flex items-start">
                            <div class="w-12 h-12 bg-gradient-to-br {{ 
                                $faq['color'] == 'blue' ? 'from-blue-500 to-cyan-500' : 
                                ($faq['color'] == 'purple' ? 'from-purple-500 to-pink-500' : 

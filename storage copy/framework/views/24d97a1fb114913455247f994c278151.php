...
<?php $__env->startSection('title', 'Create Accreditation'); ?>
        ...
        <form action="<?php echo e(route('admin.accreditations.store')); ?>" method="POST">
            ...
            <div class="mb-5">
                ...
                <select name="type"
                    ...
                    <option value="international" <?php echo e(old('type') == 'international' ? 'selected' : ''); ?>>International Accreditation</option>
                    <option value="membership" <?php echo e(old('type') == 'membership' ? 'selected' : ''); ?>>Membership</option>
                </select>
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/accreditations/create.blade.php ENDPATH**/ ?>
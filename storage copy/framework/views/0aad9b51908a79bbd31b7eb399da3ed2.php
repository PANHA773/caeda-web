        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                >
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category['id'] == 'all'): ?>
...
<section id="workshops-grid" class="py-20 px-4 md:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $workshops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $workshop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div
                ...
                >
                    ...
                    <div class="relative h-48 bg-gray-900 overflow-hidden">
                        ...
                        <div id="video-<?php echo e($workshop->id); ?>" class="hidden absolute inset-0">
                            <iframe
                                data-src="<?php echo e($workshop->video_url); ?>?autoplay=1"
                                class="w-full h-full"
                                frameborder="0"
                        ...
                        <img
                            id="thumb-<?php echo e($workshop->id); ?>"
                        ...
                        <button
                            onclick="playWorkshop(<?php echo e($workshop->id); ?>)"
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <span class="text-sm text-gray-600">
                                ⭐ <?php echo e($workshop->rating); ?> (<?php echo e($workshop->attendees); ?>)
                            </span>
                        </div>
                        ...
                        <div class="flex items-center mb-4 p-3 bg-gray-50 rounded-xl">
                            <img
                                src="<?php echo e(asset('storage/'.$workshop->instructor_image)); ?>"
                                class="w-10 h-10 rounded-full object-cover border"
                            />
                            <div class="ml-3">
                                <p class="text-sm font-semibold"><?php echo e($workshop->instructor); ?></p>
                                <p class="text-xs text-gray-500">Expert Instructor</p>
                            </div>
                        </div>

                        <div class="flex justify-between items-center text-sm text-gray-500">
                            <?php echo e(\Carbon\Carbon::parse($workshop->date)->format('M d, Y')); ?>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="glass-effect rounded-3xl p-8 md:p-12 border border-blue-200/50 shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $upcomingWorkshops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $workshop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div 
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center mb-3">
                                    <div class="relative w-6 h-6 rounded-full overflow-hidden border border-white shadow-sm instructor-image mr-2">
                                        <img
                                            src="<?php echo e($workshop->instructor_image); ?>"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($upcomingWorkshops->isEmpty()): ?>
...
<section class="py-20 px-4 md:px-8 bg-white">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div
...
<section class="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 px-4 md:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                >
                    ...
                    <div class="flex items-center mb-6">
                        <div class="relative w-14 h-14 rounded-full overflow-hidden border-4 border-white shadow-lg mr-4 transform transition-all duration-500 group-hover:scale-110">
                            <img
                                src="<?php echo e($testimonial->avatar ?: asset('images/avatar-placeholder.png')); ?>"
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testimonial->company): ?>
                    ...
                    <div class="mb-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                            <span
                                ...
                                <?php echo e($i <= $testimonial->rating
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testimonial->workshop): ?>
                        <div class="border-t border-gray-200 pt-4">
                            <p class="text-sm text-blue-600 font-semibold">
                                Workshop: <?php echo e($testimonial->workshop); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/workshop.blade.php ENDPATH**/ ?>
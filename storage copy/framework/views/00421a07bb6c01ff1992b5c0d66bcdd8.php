        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($partners->count()); ?></p>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600 mt-1">
                        <?php echo e($partners->where('is_active', true)->count()); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-red-600 mt-1">
                        <?php echo e($partners->where('is_active', false)->count()); ?>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="py-4 px-6 text-sm font-medium text-gray-900"><?php echo e($loop->iteration); ?></td>
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="relative group">
                                        <div class="flex-shrink-0 h-12 w-12 bg-gray-100 rounded-lg overflow-hidden p-2 cursor-pointer hover:ring-2 hover:ring-indigo-300 transition-all duration-200"
                                             onclick="openImageViewer('<?php echo e($logo); ?>', '<?php echo e($partner->name); ?>')">
                        ...
                        <td class="py-4 px-6">
                            <div>
                                <p class="text-sm font-medium text-gray-900"><?php echo e($partner->name); ?></p>
                                <p class="text-xs text-gray-500 mt-1">ID: <?php echo e($partner->id); ?></p>
                            </div>
                        </td>
                        
                        <td class="py-4 px-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($partner->website_url): ?>
                                <a href="<?php echo e($partner->website_url); ?>" 
                                   ...
                                   class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-800 hover:underline">
                                    <span class="truncate max-w-[150px]"><?php echo e($partner->website_url); ?></span>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/partners/index.blade.php ENDPATH**/ ?>
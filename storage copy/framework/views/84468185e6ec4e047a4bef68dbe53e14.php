...
<?php $__env->startSection('title', 'Edit Contact Method'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-3xl mx-auto p-6 bg-white rounded-2xl shadow">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Edit Contact Method</h1>
    ...
    <form action="<?php echo e(route('admin.contact-information.update', $contact->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" id="title"
                   ...
                   value="<?php echo e(old('title', $contact->title)); ?>" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="icon" id="icon"
                   class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                   value="<?php echo e(old('icon', $contact->icon)); ?>" required>
        ...
        <div class="mb-4">
            ...
            <textarea name="content" id="content" rows="4"
                      class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      required><?php echo e(old('content', $contact->content)); ?></textarea>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="color" id="color"
                   class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                   value="<?php echo e(old('color', $contact->color)); ?>" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="action" id="action"
                   class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                   value="<?php echo e(old('action', $contact->action)); ?>">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="action_icon" id="action_icon"
                   class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                   value="<?php echo e(old('action_icon', $contact->action_icon)); ?>">
        ...
        <div class="mb-6 flex items-center space-x-2">
            <input type="checkbox" name="is_active" id="is_active"
                   ...
                   <?php echo e(old('is_active', $contact->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/contact-information/edit.blade.php ENDPATH**/ ?>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 backdrop-blur-sm">
            ...
            <p class="text-center text-gray-600 text-sm mt-6">
                <?php echo e(__('Are you an admin?')); ?>

                <a href="<?php echo e(route('admin.login')); ?>" class="text-blue-600 font-semibold hover:underline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/auth/login.blade.php ENDPATH**/ ?>
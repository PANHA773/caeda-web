<?php $__env->startSection('title', 'CAEDA News'); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between mb-8 p-4 bg-white rounded-xl shadow-sm">
            <div class="flex items-center space-x-6 mb-4 sm:mb-0">
                <div class="text-center">
                    <div class="text-2xl font-bold gradient-text"><?php echo e($news->total()); ?></div>
                    <div class="text-sm text-gray-500">Total Posts</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl font-bold gradient-text"><?php echo e($news->count()); ?></div>
                    <div class="text-sm text-gray-500">Showing</div>
                </div>
                <div class="text-center">
                    <div class="text-2xl font-bold gradient-text"><?php echo e(optional($news->first())->likes ?? 0); ?></div>
        ...
        <div class="space-y-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="news-card animate-fadeInUp" style="animation-delay: <?php echo e($index * 0.1); ?>s;">
                    <div class="p-6 md:p-8">
                        ...
                        <div class="flex items-start justify-between mb-6">
                            <div class="flex items-center space-x-4">
                                <div class="relative avatar-ring online">
                                    <img 
                                        src="<?php echo e(data_get($post, 'user.avatar', 'https://ui-avatars.com/api/?name=' . urlencode(data_get($post, 'user.name', 'CAEDA')) . '&background=4F46E5&color=fff&bold=true')); ?>" 
                                        alt="<?php echo e(data_get($post,'user.name','CAEDA')); ?>" 
                                        class="w-14 h-14 rounded-full object-cover"
                                    >
                                </div>
                                <div>
                                    <div class="flex items-center space-x-2">
                                        <h3 class="font-bold text-gray-900"><?php echo e(data_get($post, 'user.name', 'CAEDA')); ?></h3>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(data_get($post,'user.verified')): ?>
                                    ...
                                    <div class="flex items-center space-x-3 text-sm text-gray-500 mt-1">
                                        ...
                                        <span class="text-indigo-600 font-medium">
                                            <?php echo e(data_get($post,'user.role','Admin')); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->title): ?>
                            <h2 class="text-2xl font-bold text-gray-900 mb-3 leading-tight">
                                <a href="<?php echo e(route('news.show', $post->slug)); ?>" class="hover:text-indigo-600 transition-colors duration-200">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->excerpt): ?>
                            <p class="text-gray-700 text-lg mb-6"><?php echo e($post->excerpt); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->image): ?>
                            <div class="news-image-container mb-6">
                                <img 
                                    src="<?php echo e($post->image ? (\Illuminate\Support\Str::startsWith($post->image, ['http://','https://']) ? $post->image : asset($post->image)) : ''); ?>" 
                                    alt="<?php echo e($post->title ?? 'News image'); ?>" 
                        ...
                        <div class="text-gray-800 mb-6 leading-relaxed">
                            <?php echo Str::limit(strip_tags($post->content), 400); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strlen(strip_tags($post->content)) > 400): ?>
                                <a href="<?php echo e(route('news.show', $post->slug)); ?>" class="text-indigo-600 hover:text-indigo-800 font-medium ml-2">
                                    Read more <i class="fas fa-arrow-right ml-1"></i>
                                </a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($post->tags)): ?>
                        ...
                        <div class="pt-6 border-t border-gray-200">
                            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                ...
                                <div class="flex items-center space-x-6 text-sm text-gray-600">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span id="likes-number-<?php echo e($post->id); ?>" class="font-medium"><?php echo e($post->likes); ?></span>
                                        <span>Likes</span>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span id="comments-number-<?php echo e($post->id); ?>" class="font-medium"><?php echo e($post->comments); ?></span>
                                        <span>Comments</span>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="font-medium"><?php echo e($post->shares); ?></span>
                                        <span>Shares</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-2">
                                    <button 
                                        onclick="likePost(<?php echo e($post->id); ?>, this)" 
                                        data-liked="<?php echo e($post->is_liked ? 'true' : 'false'); ?>" 
                                        class="interaction-btn <?php echo e($post->is_liked ? 'active' : ''); ?>"
                                    >
                                        <i class="fas fa-thumbs-up mr-2"></i>
                                        <span id="like-button-text-<?php echo e($post->id); ?>">
                                            <?php echo e($post->is_liked ? 'Liked' : 'Like'); ?>

                                        </span>
                                    </button>
                                    
                                    <button 
                                        onclick="toggleCommentForm(<?php echo e($post->id); ?>)" 
                                    ...
                                    <div class="relative">
                                        <button 
                                            onclick="toggleShareMenu(<?php echo e($post->id); ?>)" 
                                            class="interaction-btn"
                                        >
                                        ...
                                        <div 
                                            id="share-menu-<?php echo e($post->id); ?>" 
                                            class="hidden absolute right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg py-2 z-10 min-w-48"
                                        >
                                            <a 
                                                target="_blank" 
                                                rel="noopener" 
                                                href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(route('news.show', $post->slug))); ?>"
                                            ...
                                            <a 
                                                target="_blank" 
                                                rel="noopener" 
                                                href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(route('news.show', $post->slug))); ?>&text=<?php echo e(urlencode($post->title)); ?>"
                                                class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-150"
                                            >
                                            ...
                                            <a 
                                                target="_blank" 
                                                rel="noopener" 
                                                href="https://api.whatsapp.com/send?text=<?php echo e(urlencode($post->title . ' ' . route('news.show', $post->slug))); ?>"
                                                class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-150"
                                            >
                                            ...
                                            <div class="border-t border-gray-200 mt-2 pt-2">
                                                <button 
                                                    onclick="copyLink('<?php echo e(route('news.show', $post->slug)); ?>')"
                            ...
                            <div 
                                id="comments-section-<?php echo e($post->id); ?>" 
                                class="mt-6 space-y-4 max-h-80 overflow-y-auto custom-scrollbar p-2 hidden"
                            >
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $post->commentsList->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="comment-card">
                                        <div class="flex items-start space-x-3">
                                            <div class="w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white text-xs font-bold">
                                                <?php echo e(substr($comment->name ?? 'G', 0, 1)); ?>

                                            </div>
                                            <div class="flex-1">
                                                <div class="text-sm text-gray-700 leading-relaxed"><?php echo e($comment->content); ?></div>
                                                <div class="flex items-center justify-between mt-2">
                                                    <span class="text-xs text-gray-500 font-medium">
                                                        <?php echo e($comment->name ?? 'Guest'); ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->commentsList->isEmpty()): ?>
                            ...
                            <form 
                                id="comment-form-<?php echo e($post->id); ?>" 
                                onsubmit="submitComment(event, <?php echo e($post->id); ?>)" 
            ...
            <div class="mt-12 bg-white rounded-xl shadow-sm p-6">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div class="text-sm text-gray-600">
                        Showing <?php echo e($news->firstItem()); ?> to <?php echo e($news->lastItem()); ?> of <?php echo e($news->total()); ?> results
                    </div>
                    <div class="flex items-center space-x-2">
                        <?php echo e($news->links('vendor.pagination.tailwind-custom')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/news.blade.php ENDPATH**/ ?>
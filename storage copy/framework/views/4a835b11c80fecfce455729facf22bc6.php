...
<?php $__env->startSection('title', 'Add Value & Benefit'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('admin.value-benefits.store')); ?>" method="POST" id="valueForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                              placeholder="Enter a brief description (optional)"><?php echo e(old('description')); ?></textarea>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/value-benefits/create.blade.php ENDPATH**/ ?>
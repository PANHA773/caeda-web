...
<div class="space-y-6">
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a href="<?php echo e(route($action['route'])); ?>" class="group bg-white border border-gray-200 rounded-xl p-4 hover:border-<?php echo e($action['color']); ?>-300 hover:shadow-md transition-all duration-300">
                <div class="flex items-center space-x-4">
                    <div class="w-12 h-12 <?php echo e($action['bg']); ?> rounded-lg flex items-center justify-center group-hover:bg-<?php echo e($action['color']); ?>-100 transition-colors">
                        <i class="<?php echo e($action['icon']); ?> text-<?php echo e($action['color']); ?>-600 text-xl"></i>
                    </div>
                    <div>
                        <h3 class="font-semibold text-gray-900 group-hover:text-<?php echo e($action['color']); ?>-700"><?php echo e($action['title']); ?></h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('admin.activity.index')); ?>" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">View All</a>
            </div>
            <div class="space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="font-medium <?php echo e($dbStatus === 'Healthy' ? 'text-green-600' : 'text-red-600'); ?>"><?php echo e($dbStatus); ?></span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="<?php echo e($dbStatus === 'Healthy' ? 'bg-green-600' : 'bg-red-600'); ?> h-2 rounded-full" style="width: <?php echo e($dbPercent); ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between items-center mb-2">

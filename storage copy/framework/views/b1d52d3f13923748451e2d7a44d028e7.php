<?php $__env->startSection('title', 'Events - CAEDA'); ?>
...
<section class="relative py-24 px-4 md:px-8 overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
    <div class="absolute inset-0">
        ...
        <div class="absolute top-0 left-0 w-full h-full bg-[url('https://images.unsplash.com/photo-1540575467063-178a50c2df87?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')] bg-cover bg-center opacity-20"></div>
    </div>
    ...
    <div class="absolute top-1/3 right-1/4 w-16 h-16 bg-pink-500/20 rounded-full animate-float" style="animation-delay: 2s"></div>
    ...
    <div class="max-w-7xl mx-auto relative z-10">
        <div class="text-center">
            ...
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-white font-cinzel">
                ...
                <span class="block">Events & <span class="bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent animate-gradient-x">Conferences</span></span>
            </h1>

            <p class="text-xl md:text-2xl text-blue-100 mb-10 max-w-3xl mx-auto leading-relaxed">
                Join industry leaders, innovators, and peers at our premier events designed to educate, inspire, and connect.
            </p>

            <div class="flex flex-col sm:flex-row gap-4 justify-center animate-slide-in-right">
                <button onclick="scrollToEvents()" class="group bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl shadow-lg flex items-center">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredEvent): ?>
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-10">
                ...
                <div class="lg:w-1/2">
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                        <?php echo $featuredEvent->title; ?>

                    </h2>

                    <p class="text-gray-600 mb-6 text-lg">
                        <?php echo $featuredEvent->description; ?>
                    ...
                    <div class="flex flex-wrap gap-4 mb-8">
                        ...
                        <div class="flex items-center text-gray-700">
                            ...
                            <span><?php echo e($featuredEvent->location); ?></span>
                        </div>
                        ...
                        <div class="flex items-center text-gray-700">
                            ...
                            <span><?php echo e($featuredEvent->start_date->format('M d, Y')); ?>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredEvent->start_time): ?>
                                    • <?php echo e(\Carbon\Carbon::parse($featuredEvent->start_time)->format('h:i A')); ?>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="flex items-center">
                            <div class="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center text-white font-bold mr-3">
                                <?php echo e($featuredEvent->speakers_count); ?>+
                            </div>
                        ...
                        <div class="flex items-center">
                            <div class="w-10 h-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold mr-3">
                                <?php echo e($featuredEvent->sessions_count); ?>+
                            </div>
                            <span class="text-gray-700">Sessions</span>
                        </div>
                        <div class="flex items-center">
                            <div class="w-10 h-10 rounded-full bg-gradient-to-r from-green-500 to-teal-500 flex items-center justify-center text-white font-bold mr-3">
                                <?php echo e($featuredEvent->attendees_count); ?>+
                            </div>
                    ...
                    <div class="bg-gradient-to-br from-blue-900 to-purple-900 rounded-2xl p-8 text-center shadow-2xl">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                <div id="countdown-days" class="text-4xl md:text-5xl font-bold text-white countdown-number">00</div>
                                <div class="text-blue-200 text-sm mt-2">Days</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                <div id="countdown-hours" class="text-4xl md:text-5xl font-bold text-white countdown-number">00</div>
                                <div class="text-blue-200 text-sm mt-2">Hours</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                <div id="countdown-minutes" class="text-4xl md:text-5xl font-bold text-white countdown-number">00</div>
                                <div class="text-blue-200 text-sm mt-2">Minutes</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                <div id="countdown-seconds" class="text-4xl md:text-5xl font-bold text-white countdown-number">00</div>
                                <div class="text-blue-200 text-sm mt-2">Seconds</div>
                            </div>
                        </div>

                        <button class="w-full bg-gradient-to-r from-cyan-400 to-blue-400 hover:from-cyan-500 hover:to-blue-500 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                            Register Now - Early Bird 30% OFF
                        </button>

                        <p class="text-blue-200 text-sm mt-4">Limited seats available • Price increases in <span class="font-bold" id="countdown-price">30</span> days</p>
                    </div>
                </div>
...
<section id="upcoming-events" class="py-20 px-4 md:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-12">
            <button class="event-filter active bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-full font-medium transition-all duration-300 hover:shadow-lg" data-filter="all">
                All Events
            </button>
            <button class="event-filter bg-gray-100 hover:bg-gray-200 text-gray-800 px-6 py-3 rounded-full font-medium transition-all duration-300 hover:shadow-lg" data-filter="conference">
                <i class="fas fa-users mr-2"></i> Conferences
            </button>
            <button class="event-filter bg-gray-100 hover:bg-gray-200 text-gray-800 px-6 py-3 rounded-full font-medium transition-all duration-300 hover:shadow-lg" data-filter="workshop">
                <i class="fas fa-laptop-code mr-2"></i> Workshops
            </button>
            <button class="event-filter bg-gray-100 hover:bg-gray-200 text-gray-800 px-6 py-3 rounded-full font-medium transition-all duration-300 hover:shadow-lg" data-filter="networking">
                <i class="fas fa-handshake mr-2"></i> Networking
            </button>
            <button class="event-filter bg-gray-100 hover:bg-gray-200 text-gray-800 px-6 py-3 rounded-full font-medium transition-all duration-300 hover:shadow-lg" data-filter="webinar">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div
                ...
                data-type="<?php echo e($event['type']); ?>"
                style="animation-delay: <?php echo e($index * 150); ?>ms">
                <div class="relative overflow-hidden h-56">
                    <img
                        src="<?php echo e($event['image']); ?>"
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                        <div class="text-white font-semibold"><?php echo e($event->date->format('M d, Y')); ?> • <?php echo e($event->time); ?></div>
                        <div class="text-blue-200 text-sm"><?php echo e($event->location); ?></div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-4">
                        <div class="flex-1">
                            <span class="text-xs font-semibold px-3 py-1 rounded-full <?php echo e($event->type == 'conference' ? 'bg-blue-100 text-blue-600' : 
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mt-3"><?php echo e($event->title); ?></h3>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between text-sm text-gray-500 mb-6">
                        <div class="flex items-center">
                            ...
                            <span><?php echo e($event->speakers); ?> Speakers</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-4 h-4 text-green-500 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                            <span><?php echo e($event->seats); ?> Seats</span>
                        </div>
                    </div>

                    <div class="flex gap-3">
                        <button
                            onclick="registerForEvent(<?php echo e($event->id); ?>)"
                            ...
                            <?php echo e($event->tag == 'Sold Out' ? 'disabled' : ''); ?>>
                            <?php echo e($event->tag == 'Sold Out' ? 'Sold Out' : 'Register Now'); ?>
        ...
        <div class="text-center mt-12">
            <button id="load-more-events" class="bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 text-gray-800 font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
                Load More Events
            </button>
        </div>
    </div>
            ...
            <div class="lg:col-span-2">
                <div class="glass-effect rounded-3xl p-8 shadow-2xl">
                    ...
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-2xl font-bold text-gray-900"><?php echo e($monthName); ?></h3>
                    </div>
                    ...
                    <div class="grid grid-cols-7 gap-2 mb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < $startDay; $i++): ?>
                            <div>
                    </div>
                    <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($day = 1; $day <= $totalDays; $day++): ?>
                        <?php
                        ...
                        <div class="rounded-xl p-3 cursor-pointer transition-all duration-300
                                    <?php echo e($isToday ? 'calendar-day-active' : 'bg-white hover:bg-gray-50'); ?>

                                    <?php echo e($hasEvent ? 'border-2 border-blue-200' : ''); ?>">

                            <div class="text-lg font-bold <?php echo e($isToday ? 'text-white' : 'text-gray-900'); ?>">
                                <?php echo e($day); ?>

                            </div>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasEvent): ?>
    ...
    <div class="lg:col-span-1">
        <div class="glass-effect rounded-3xl p-8 shadow-2xl h-full">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-start p-4 rounded-2xl bg-gradient-to-r from-blue-50 to-purple-50 hover:from-blue-100 hover:to-purple-100 transition-all duration-300 group">
                    <div class="text-center mr-4">
                        <div class="text-2xl font-bold text-blue-600"><?php echo e($event->date->format('d')); ?></div>
                        <div class="text-sm text-gray-500"><?php echo e($event->date->format('M')); ?></div>
                    </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center text-sm text-gray-600 mt-1">
                            ...
                            <?php echo e($event->formatted_time); ?>
...
<section class="py-20 px-4 md:px-8 bg-white">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $speakers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $speaker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="group text-center animate-fade-in-up" style="animation-delay: <?php echo e($index * 200); ?>ms">
                <div class="relative mb-6">
                    <div class="relative w-40 h-40 mx-auto rounded-full overflow-hidden border-4 border-white shadow-2xl group-hover:border-blue-300 transition-all duration-500">
                        <img
                            src="<?php echo e($speaker->image); ?>"
                            alt="<?php echo e($speaker->name); ?>"
                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    </div>
                    <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg">
                        <?php echo e($speaker->topic); ?>

                    </div>
                </div>

                <h3 class="text-xl font-bold text-gray-900 mb-2"><?php echo e($speaker->name); ?></h3>
                <p class="text-gray-600 mb-4"><?php echo e($speaker->title); ?></p>
                ...
                <div class="flex justify-center space-x-3">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $socialLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="#" class="w-10 h-10 rounded-full bg-gray-100 hover:bg-blue-100 flex items-center justify-center text-gray-600 hover:text-blue-600 transition-all duration-300 hover:scale-110">
        ...
        <div class="text-center mt-12">
            <a href="<?php echo e(route('speakers.index')); ?>" class="bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 text-gray-800 font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl inline-block">
                View All Speakers
            </a>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="relative max-w-4xl mx-auto">
            ...
            <div class="space-y-12">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $timelineEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative flex flex-col md:flex-row items-start animate-fade-in-up" style="animation-delay: <?php echo e($index * 150); ?>ms">
                        
                        <div class="timeline-dot flex-shrink-0 w-12 h-12 rounded-full <?php echo e($event->status == 'completed' ? 'bg-green-100 border-4 border-green-300' : 
                                ($event->status == 'active' ? 'bg-blue-100 border-4 border-blue-300 animate-pulse' : 'bg-gray-100 border-4 border-gray-300')); ?> flex items-center justify-center mb-4 md:mb-0">
                            <i class="<?php echo e($event->icon); ?> <?php echo e($event->status == 'completed' ? 'text-green-600' : 
                                    ($event->status == 'active' ? 'text-blue-600' : 'text-gray-600')); ?>"></i>
                        </div>

                        
                        <div class="md:ml-8 flex-1 bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 <?php echo e($event->status == 'active' ? 'border-2 border-blue-300' : ''); ?>">
                            <div class="flex flex-col md:flex-row md:items-center justify-between mb-3">
                                <h3 class="text-xl font-bold text-gray-900"><?php echo e($event->title); ?></h3>
                                <span class="text-sm font-semibold px-3 py-1 rounded-full <?php echo e($event->status == 'completed' ? 'bg-green-100 text-green-600' : 
...
<section class="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 text-white relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10 px-4 md:px-8">
        <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Ready to <span class="bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent">Join</span> Our Events?
        </h2>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <button onclick="scrollToEvents()" class="group bg-white text-blue-600 hover:bg-gray-50 font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl shadow-lg">
        ...
        <p class="text-sm opacity-80 mt-8">Flexible registration options • Group discounts available • Money-back guarantee</p>
    </div>
</section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/events.blade.php ENDPATH**/ ?>
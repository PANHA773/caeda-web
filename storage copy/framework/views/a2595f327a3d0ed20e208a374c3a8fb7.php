...
<?php $__env->startSection('title', 'Edit Value & Benefit'); ?>
            ...
            <nav class="flex mb-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="<?php echo e(route('admin.value-benefits.index')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit: <?php echo e($valueBenefit->title); ?></span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-3xl font-bold text-gray-900">Edit Value / Benefit</h1>
            <p class="text-gray-600 mt-2">Update details for <?php echo e($valueBenefit->title); ?></p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <form action="<?php echo e(route('admin.value-benefits.update', $valueBenefit->id)); ?>" 
                          method="POST" 
                          id="valueForm">
                        <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" 
                                           name="title"
                                           id="titleInput"
                                           value="<?php echo e(old('title', $valueBenefit->title)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                              placeholder="Enter a brief description (optional)"><?php echo e(old('description', $valueBenefit->description ?? '')); ?></textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               name="order"
                                               id="orderInput"
                                               value="<?php echo e(old('order', $valueBenefit->order)); ?>"
                                               min="0"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" 
                                               name="icon"
                                               id="iconInput"
                                               value="<?php echo e(old('icon', $valueBenefit->icon ?? '')); ?>"
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" 
                                           ...
                                           value="1"
                                           class="sr-only peer"
                                           <?php echo e(old('is_active', $valueBenefit->is_active) ? 'checked' : ''); ?>>
                                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    <span class="ml-3 text-sm font-medium text-gray-900">
                                        <span id="statusText"><?php echo e($valueBenefit->is_active ? 'Active' : 'Inactive'); ?></span>
                                    </span>
                                </label>
                            </div>
        ...
        <div class="space-y-6">
                ...
                <div class="p-6">
                    <div class="text-center">
                        ...
                        <div class="mb-4 flex justify-center">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($valueBenefit->icon): ?>
                                <div class="h-16 w-16 bg-gradient-to-br from-green-100 to-emerald-100 rounded-xl flex items-center justify-center">
                                    <div class="text-green-600 text-2xl">
                                        <i class="<?php echo e($valueBenefit->icon); ?>"></i>
                                    </div>
                                </div>
                            <?php else: ?>
                        ...
                        <!-- Title Preview -->
                        <h3 class="text-xl font-bold text-gray-900 mb-2"><?php echo e($valueBenefit->title); ?></h3>
                        
                        <!-- Description Preview -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($valueBenefit->description): ?>
                            <p class="text-gray-600 text-sm mb-4"><?php echo e($valueBenefit->description); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        
                        <!-- Status Badge -->
                        <div class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($valueBenefit->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?> mb-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($valueBenefit->is_active): ?>
                        ...
                        <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm">
                                ...
                                <div class="font-medium"><?php echo e($valueBenefit->order); ?></div>
                                <div class="text-gray-700">Status:</div>
                                <div class="font-medium"><?php echo e($valueBenefit->is_active ? 'Active' : 'Inactive'); ?></div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($valueBenefit->icon): ?>
                                    <div class="text-gray-700">Icon:</div>
                                    <div class="font-medium truncate"><?php echo e($valueBenefit->icon); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="text-center">
                        ...
                        <!-- Title Preview -->
                        <h3 id="previewTitle" class="text-xl font-bold text-gray-900 mb-2"><?php echo e($valueBenefit->title); ?></h3>
                        
                        <!-- Description Preview -->
                        <p id="previewDescription" class="text-gray-600 text-sm mb-4">
                            <?php echo e($valueBenefit->description ?? 'This is a preview of the description. It will appear here when you type.'); ?>
                        ...
                        <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm">
                                <div class="text-gray-700">Order:</div>
                                <div class="font-medium" id="previewOrder"><?php echo e($valueBenefit->order); ?></div>
                                <div class="text-gray-700">Status:</div>
                                <div class="font-medium" id="previewStatusText"><?php echo e($valueBenefit->is_active ? 'Active' : 'Inactive'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-red-200 border-t-4 border-t-red-500">
                ...
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('admin.value-benefits.destroy', $valueBenefit->id)); ?>" 
                          method="POST" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const hasExistingIcon = '<?php echo e($valueBenefit->icon ?? ''); ?>'.length > 0;
    const existingIcon = '<?php echo e($valueBenefit->icon ?? ''); ?>';
    ...
    function updatePreview() {
        ...
        if (titleInput.value.trim()) {
            ...
            previewTitle.textContent = '<?php echo e($valueBenefit->title); ?>';
        }
        ...
        if (descriptionInput.value.trim()) {
            ...
            previewDescription.textContent = '<?php echo e($valueBenefit->description ?? "This is a preview of the description. It will appear here when you type."); ?>';
        }
        
        // Order preview
        previewOrder.textContent = orderInput.value || '<?php echo e($valueBenefit->order); ?>';
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/value-benefits/edit.blade.php ENDPATH**/ ?>
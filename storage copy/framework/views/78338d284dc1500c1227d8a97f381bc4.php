...
<?php $__env->startSection('title', 'Edit Goal'); ?>
...
<div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <div>
                <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-3">
                    <a href="<?php echo e(route('admin.goals.index')); ?>" class="hover:text-blue-600 transition">Goals & Strategies</a>
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                    <span class="text-gray-400">Edit Goal #<?php echo e($goal->id); ?></span>
                </nav>
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Update goal details for "<?php echo e($goal->title); ?>"</p>
                    </div>
                </div>
            </div>
            <a href="<?php echo e(route('admin.goals.index')); ?>" class="mt-4 sm:mt-0 inline-flex items-center px-4 py-3 bg-gradient-to-r from-gray-100 to-gray-50 text-gray-700 font-medium rounded-lg hover:from-gray-200 hover:to-gray-100 transition-all shadow-sm hover:shadow-md border border-gray-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
                ...
                <p class="text-lg font-semibold text-gray-900"><?php echo e($goal->created_at->format('M d, Y')); ?></p>
            </div>
            <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
                <p class="text-sm font-medium text-gray-600">Status</p>
                <div class="flex items-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($goal->is_active): ?>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
                ...
                <p class="text-lg font-semibold text-gray-900"><?php echo e($goal->order); ?></p>
            </div>
            <div class="bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl p-4 border border-yellow-200">
                <p class="text-sm font-medium text-gray-600">Last Updated</p>
                <p class="text-lg font-semibold text-gray-900"><?php echo e($goal->updated_at->diffForHumans()); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-gradient-to-br from-white via-white to-gray-50 rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <form action="<?php echo e(route('admin.goals.update', $goal->id)); ?>" method="POST" class="p-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                <input type="text" name="title" id="title" value="<?php echo e(old('title', $goal->title)); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5"
                                      ...
                                      placeholder="Describe the goal in detail..."><?php echo e(old('description', $goal->description)); ?></textarea>
                            <div class="flex justify-between mt-1">
                                <span class="text-xs text-gray-500">Briefly describe what this goal aims to achieve</span>
                                <span class="text-xs text-gray-400" id="charCount"><?php echo e(strlen($goal->description)); ?> characters</span>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    <div id="iconPreview" class="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-indigo-100 to-purple-100 border border-indigo-200 text-2xl">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($goal->icon): ?>
                                            <i class="<?php echo e($goal->icon); ?> text-indigo-600"></i>
                                        <?php else: ?>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500"><?php echo e($goal->icon ?: 'No icon set'); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="relative">
                                <input type="text" name="icon" id="icon" value="<?php echo e(old('icon', $goal->icon)); ?>"
                                       class="w-full px-4 py-3 pl-11 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white hover:border-gray-400"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="order" id="order" value="<?php echo e(old('order', $goal->order)); ?>"
                                           class="w-full px-4 py-3 pl-11 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white hover:border-gray-400">
                                    <div class="absolute left-3 top-3 text-gray-400">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                    <div class="relative">
                                        <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', $goal->is_active) ? 'checked' : ''); ?> class="sr-only peer">
                                    ...
                                    <div>
                                        <span class="text-sm font-medium text-gray-900" id="statusText"><?php echo e($goal->is_active ? 'Active' : 'Inactive'); ?></span>
                ...
                <div class="mt-10 pt-8 border-t border-gray-200">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                        ...
                        <div class="flex space-x-4">
                            <a href="<?php echo e(route('admin.goals.index')); ?>" class="px-6 py-3 bg-gradient-to-r from-gray-100 to-gray-50 text-gray-700 font-medium rounded-lg hover:from-gray-200 hover:to-gray-100 transition-all shadow-sm hover:shadow-md border border-gray-200">
                                Cancel
                            </a>
                            ...
                            <a href="<?php echo e(route('admin.goals.create')); ?>" class="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all shadow-sm hover:shadow-md flex items-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-8 bg-gradient-to-br from-white via-white to-gray-50 rounded-2xl shadow-lg border border-red-200 overflow-hidden">
            ...
            <div class="p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <form action="<?php echo e(route('admin.goals.destroy', $goal->id)); ?>" method="POST" 
                          onsubmit="return confirm('⚠️ Are you absolutely sure? This will permanently delete the goal \'<?php echo e($goal->title); ?>\' and cannot be undone.');">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/goals/edit.blade.php ENDPATH**/ ?>
...
<div class="max-w-3xl mx-auto px-4 py-6">
    ...
    <form action="<?php echo e(route('admin.social.update', $social->id)); ?>" method="POST" class="bg-white p-6 rounded-xl shadow">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="platform" id="platform"
                   value="<?php echo e(old('platform', $social->platform)); ?>"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="icon" id="icon"
                   value="<?php echo e(old('icon', $social->icon)); ?>"
                   class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="color" id="color"
                   value="<?php echo e(old('color', $social->color)); ?>"
                   class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300"
        ...
        <div class="mb-4">
            ...
            <input type="url" name="url" id="url"
                   value="<?php echo e(old('url', $social->url)); ?>"
                   class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring focus:ring-blue-300"
        ...
        <div class="mb-4 flex items-center space-x-3">
            <input type="checkbox" name="is_active" id="is_active" value="1" 
                   <?php echo e(old('is_active', $social->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/social/edit.blade.php ENDPATH**/ ?>
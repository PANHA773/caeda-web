...
<?php $__env->startSection('title', 'Create Menu Category'); ?>
...
<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="<?php echo e(route('admin.menu-categories.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/menu-categories/create.blade.php ENDPATH**/ ?>
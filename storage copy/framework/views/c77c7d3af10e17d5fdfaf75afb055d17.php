<?php $__env->startSection('title', 'Membership - CAEDA'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div class="relative">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 items-center justify-items-center relative z-10">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="group relative" style="animation-delay: <?php echo e($index * 100); ?>ms">
                        <div class="relative transform transition-all duration-500 group-hover:scale-110 group-hover:z-20">
                            ...
                            <div class="relative bg-white rounded-xl p-4 shadow-lg border border-gray-100 backdrop-blur-sm transition-all duration-500 ease-out group-hover:shadow-2xl group-hover:border-blue-200">
                                <a href="<?php echo e($partner->website_url ?: '#'); ?>" target="_blank" rel="noopener noreferrer" class="inline-block">
                                    <img 
                                        src="<?php echo e($partner->logo); ?>" 
                                        ...
                                        onerror="this.src='<?php echo e(asset('assets/default-logo.png')); ?>'">
                                </a>
                            </div>
...
<section class="py-20 px-4 md:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $memberCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div 
                ...
                >
                    <div class="absolute inset-0 bg-gradient-to-br <?php echo e($company['color']); ?> opacity-0 group-hover:opacity-5 transition-opacity duration-500"></div>
                    
                    <div class="relative z-10">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <div class="text-4xl mr-4 transition-all duration-500 transform group-hover:scale-110 group-hover:animate-<?php echo e($company['animation']); ?>">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600"><?php echo e($company['industry']); ?></p>
                                </div>
                            </div>
                            <span class="bg-blue-100 text-blue-600 group-hover:bg-blue-600 group-hover:text-white text-xs font-bold px-3 py-1 rounded-full transition-all duration-300 transform group-hover:scale-105">
                                <?php echo e($company['members']); ?> members
                            </span>
                        </div>
        ...
        <div class="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl shadow-2xl p-8 border border-gray-200/50 backdrop-blur-sm animate-fade-in-up">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="group text-center p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-gray-200/50 hover:border-transparent transition-all duration-500 transform hover:-translate-y-2 hover:shadow-xl animate-fade-in-up" style="animation-delay: <?php echo e($index * 200); ?>ms">
                        <div class="relative inline-block mb-4">
                            ...
                            <img
                                src="<?php echo e($member->photo ?: 'https://via.placeholder.com/80?text=No+Photo'); ?>"
                        ...
                        <h4 class="font-bold text-gray-900 text-lg mb-1"><?php echo e($member->name); ?></h4>
                        <p class="text-sm text-gray-600 mb-2"><?php echo e($member->position); ?></p>
                        <p class="text-xs text-blue-600 font-semibold mb-3"><?php echo e($member->department); ?></p>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($member->bio): ?>
                            <p class="text-sm text-gray-500 mb-3 line-clamp-2"><?php echo e($member->bio); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($member->social_links && count($member->social_links) > 0): ?>
                            <div class="flex justify-center gap-2 mt-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $member->social_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform => $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($link): ?>
                                        <a href="<?php echo e($link); ?>" target="_blank" rel="noopener noreferrer" 
                                           class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 text-gray-600 hover:bg-blue-500 hover:text-white transition-all duration-300">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($platform === 'linkedin'): ?>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div
                    data-plan="<?php echo e($plan->slug); ?>"
                    class="pricing-card relative group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 animate-fade-in-up
                        <?php echo e($plan->is_popular ? 'ring-4 ring-blue-500/20 scale-105' : ''); ?>"
                    style="animation-delay: <?php echo e($index * 200); ?>ms"
                >

                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan->is_popular && $plan->badge): ?>
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex justify-between items-start mb-6">
                            <div class="font-bold text-lg bg-gradient-to-r <?php echo e($plan->gradient); ?> bg-clip-text text-transparent">
                                <?php echo e($plan->name); ?>

                            </div>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan->members_count): ?>
                                <span class="bg-gray-100 text-gray-600 text-xs font-medium px-3 py-1 rounded-full">
                                    <?php echo e($plan->members_count); ?> members
                                </span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <div class="mb-6">
                            <span
                                ...
                                data-plan="<?php echo e($plan->slug); ?>"
                                data-monthly="<?php echo e($plan->monthly_price); ?>"
                                data-annual="<?php echo e($plan->annual_price); ?>"
                            >
                                $<?php echo e(number_format($plan->annual_price, 2)); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($savings > 0): ?>
                            <div
                                ...
                                data-plan="<?php echo e($plan->slug); ?>"
                                data-savings="<?php echo e($savings); ?>"
                                data-percentage="<?php echo e($percentage); ?>"
                            >
                                <div class="text-green-700 font-semibold text-lg">
                                    Save $<?php echo e(number_format($savings, 2)); ?> (<?php echo e($percentage); ?>%)
                                </div>
...
<section class="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 px-4 md:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div 
                ...
                >
                    ...
                    <div class="absolute inset-0 bg-gradient-to-br <?php echo e($benefit['gradient']); ?> opacity-0 group-hover:opacity-5 rounded-3xl transition-opacity duration-500 -z-10"></div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
...
<section class="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 text-white relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10 px-4 md:px-8">
        <div class="grid grid-cols-3 gap-8 mb-12">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-center animate-fade-in-up" style="animation-delay: <?php echo e($index * 200); ?>ms">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/our-team.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Add Success Story'); ?>
...
<div class="p-6">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        <form action="<?php echo e(route('admin.success-stories.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="role" id="role" value="<?php echo e(old('role')); ?>"
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                           required>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="achievement" id="achievement" rows="3"
                              class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                              required><?php echo e(old('achievement')); ?></textarea>
                </div>

                
                <div>
                    <label for="image" class="block text-gray-700 font-medium mb-1">Image URL</label>
                    <input type="text" name="image" id="image" value="<?php echo e(old('image')); ?>"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="quote" id="quote" rows="4"
                              class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                              required><?php echo e(old('quote')); ?></textarea>
                </div>

                
                <div>
                    <label for="order" class="block text-gray-700 font-medium mb-1">Order</label>
                    <input type="number" name="order" id="order" value="<?php echo e(old('order', 1)); ?>"
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                           min="1">
                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/success-stories/create.blade.php ENDPATH**/ ?>
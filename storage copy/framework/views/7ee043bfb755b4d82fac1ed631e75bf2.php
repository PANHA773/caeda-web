...
<?php $__env->startSection('title', 'Edit Order Step'); ?>
...
<div class="container mx-auto py-10">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form action="<?php echo e(route('admin.order_steps.update', $orderStep->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" id="title" required
                       value="<?php echo e(old('title', $orderStep->title)); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="4"
                          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500"><?php echo e(old('description', $orderStep->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="icon" id="icon"
                       ...
                       value="<?php echo e(old('icon', $orderStep->icon)); ?>"
                       class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="color" id="color"
                       ...
                       value="<?php echo e(old('color', $orderStep->color)); ?>"
                       class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-amber-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-6 flex items-center gap-2">
                <input type="checkbox" name="status" value="1" id="status"
                       ...
                       <?php echo e(old('status', $orderStep->status) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/order_steps/edit.blade.php ENDPATH**/ ?>
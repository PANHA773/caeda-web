...
<div class="max-w-4xl mx-auto p-8 bg-white rounded-2xl shadow-lg">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-gray-50 p-6 rounded-xl shadow-inner">
            <form action="<?php echo e(route('admin.features.update', $feature->id)); ?>" method="POST" id="featureForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="title" id="title" value="<?php echo e(old('title', $feature->title)); ?>"
                           maxlength="50"
                ...
                <div class="mb-5">
                    ...
                    <textarea name="description" id="description" rows="4" maxlength="200"
                              class="w-full border border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring focus:ring-blue-300"
                              placeholder="Brief description of the feature"><?php echo e(old('description', $feature->description)); ?></textarea>
                </div>

                
                <div class="mb-5">
                    <label for="icon" class="block text-gray-700 font-semibold mb-2">SVG Icon Path</label>
                    <input type="text" name="icon" id="icon" value="<?php echo e(old('icon', $feature->icon)); ?>"
                           class="w-full border border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring focus:ring-blue-300"
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="color" id="color" value="<?php echo e(old('color', $feature->color)); ?>"
                           class="w-full border border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring focus:ring-blue-300"
                ...
                <div class="mb-5">
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="<?php echo e(old('sort_order', $feature->sort_order)); ?>"
                           min="0" max="999"
                           class="w-full border border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring focus:ring-blue-300">
                ...
                <div class="mb-6 flex items-center gap-6">
                    <label class="inline-flex items-center gap-2">
                        <input type="checkbox" name="is_active" value="1" <?php echo e($feature->is_active ? 'checked' : ''); ?>
                    ...
                    <label class="inline-flex items-center gap-2">
                        <input type="checkbox" name="is_popular" value="1" <?php echo e($feature->is_popular ? 'checked' : ''); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/features/edit.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Add Timeline Event'); ?>
...
<div class="container mx-auto p-6 max-w-3xl">
    ...
    <form action="<?php echo e(route('admin.timeline_events.store')); ?>" method="POST" class="bg-white p-6 rounded-xl shadow space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <textarea name="description" rows="4"
                      class="w-full border rounded px-3 py-2"
                      placeholder="Describe the event" required><?php echo e(old('description')); ?></textarea>
        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/timeline_events/create.blade.php ENDPATH**/ ?>
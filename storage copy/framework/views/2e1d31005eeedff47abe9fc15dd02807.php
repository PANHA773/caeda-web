...
<?php $__env->startSection('title', 'Edit ' . ucfirst($type) . ' Metric'); ?>
...
<div class="p-6 max-w-3xl mx-auto space-y-6">
    ...
    <div>
        <h1 class="text-2xl font-bold text-gray-800 mb-2">
            Edit <?php echo e(ucfirst($type)); ?> Metric
        </h1>
    ...
    <form action="<?php echo e(route('admin.progress-metrics.update', $item->id)); ?>?type=<?php echo e($type); ?>" 
        ...
        <div>
            ...
            <input type="text" name="label" value="<?php echo e(old('label', $item->label)); ?>" required
        ...
        <div>
            ...
            <input type="text" name="value" value="<?php echo e(old('value', $item->value)); ?>" required
                   class="w-full border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500">
        </div>

        <div>
            <label class="block font-semibold mb-1">Order</label>
            <input type="number" name="order" value="<?php echo e(old('order', $item->order)); ?>"
                   class="w-full border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500">
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'performance'): ?>
            <div>
                ...
                <input type="color" name="color" value="<?php echo e(old('color', $item->color ?? '#3b82f6')); ?>"
        ...
        <?php else: ?>
            <div>
                ...
                <select name="trend" class="w-full border-gray-300 rounded-lg p-2">
                    <option value="up" <?php echo e(old('trend', $item->trend) == 'up' ? 'selected' : ''); ?>>Up</option>
                    <option value="down" <?php echo e(old('trend', $item->trend) == 'down' ? 'selected' : ''); ?>>Down</option>
                </select>
            </div>

            <div>
                <label class="block font-semibold mb-1">Icon (FontAwesome)</label>
                <input type="text" name="icon" value="<?php echo e(old('icon', $item->icon)); ?>"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/progress-metrics/edit.blade.php ENDPATH**/ ?>
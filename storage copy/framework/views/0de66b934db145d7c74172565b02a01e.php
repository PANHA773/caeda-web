...
<?php $__env->startSection('title', 'Features Management - Admin CAEDA'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8 animate-fade-in-up">
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
                ...
                <div class="flex items-center space-x-3">
                    <a href="<?php echo e(route('admin.features.create')); ?>" 
                ...
                <div class="stats-card rounded-2xl p-6 animate-slide-in-right" style="animation-delay: 0.1s">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($features->total()); ?></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-2">
                                <?php echo e($features->where('is_active', true)->count()); ?>
                ...
                <div class="stats-card rounded-2xl p-6 animate-slide-in-right" style="animation-delay: 0.3s">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-2">
                                <?php echo e($features->unique('color')->count()); ?>
                ...
                <div class="stats-card rounded-2xl p-6 animate-slide-in-right" style="animation-delay: 0.4s">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-2">
                                <?php echo e(number_format($features->avg('sort_order') ?? 0, 0)); ?>
                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        <select class="filter-btn appearance-none bg-white border border-gray-300 rounded-xl px-4 py-2.5 pr-8 focus:outline-none focus:border-blue-500 text-sm">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['blue','red','green','yellow','purple','pink','indigo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($color); ?>" <?php echo e(request('color') == $color ? 'selected' : ''); ?>><?php echo e(ucfirst($color)); ?></option>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden animate-fade-in-up">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="feature-row" style="animation-delay: <?php echo e($loop->index * 0.05); ?>s">
                            <td class="px-6 py-5 hide-sm">#<?php echo e($feature->id); ?></td>
                            <td class="px-6 py-5">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-semibold text-gray-900 truncate"><?php echo e($feature->title); ?></p>
                                        <p class="text-sm text-gray-600 mt-1 line-clamp-2"><?php echo e($feature->description); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-5">
                                <div class="flex items-center space-x-3">
                                    <div class="color-indicator" style="background-color: <?php echo e($feature->color); ?>"></div>
                                    <div>
                                        <div class="text-sm font-medium text-gray-900 capitalize"><?php echo e($feature->color); ?></div>
                                        <div class="text-xs text-gray-500">HEX: <?php echo e($feature->color); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-5 hide-sm">
                                <span class="sort-order-badge"><?php echo e($feature->sort_order); ?></span>
                            </td>
                            <td class="px-6 py-5 hide-sm">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($feature->is_active): ?>
                            ...
                            <td class="px-6 py-5">
                                <div class="flex items-center space-x-2">
                                    <a href="<?php echo e(route('admin.features.edit', $feature->id)); ?>" 
                                    ...
                                    <form action="<?php echo e(route('admin.features.destroy', $feature->id)); ?>" method="POST" class="inline" onsubmit="return confirmDelete(event, '<?php echo e(addslashes($feature->title)); ?>')">
                                        <?php echo csrf_field(); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($features->hasPages()): ?>
                <div class="bg-gradient-to-r from-gray-50 to-blue-50 px-6 py-4 border-t border-gray-200">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            Showing <span class="font-medium"><?php echo e($features->firstItem()); ?></span> to <span class="font-medium"><?php echo e($features->lastItem()); ?></span> of <span class="font-medium"><?php echo e($features->total()); ?></span> features
                        </div>
                        <div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/features/index.blade.php ENDPATH**/ ?>
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($events->total()); ?></p>
                </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="py-4 px-6 text-sm font-medium text-gray-900"><?php echo e(($events->currentPage() - 1) * $events->perPage() + $loop->iteration); ?></td>
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="relative group">
                                        <div class="flex-shrink-0 h-12 w-12 bg-gray-100 rounded-lg overflow-hidden p-1 cursor-pointer hover:ring-2 hover:ring-indigo-300 transition-all duration-200"
                                             onclick="openImageViewer('<?php echo e($image); ?>', '<?php echo e($event->title); ?>')">
                        ...
                        <td class="py-4 px-6">
                            <div>
                                <p class="text-sm font-medium text-gray-900"><?php echo e($event->title); ?></p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->description): ?>
                                    <p class="text-xs text-gray-500 mt-1 truncate max-w-xs"><?php echo e(Str::limit($event->description, 50)); ?></p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </td>
                        ...
                        <td class="py-4 px-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->type): ?>
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($event->type == 'online' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800'); ?>">
                        ...
                        <td class="py-4 px-6">
                            <div class="text-sm text-gray-900">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->date): ?>
                                    <div class="font-medium"><?php echo e($event->date->format('M d, Y')); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->start_time || $event->end_time): ?>
                                        <div class="text-xs text-gray-500 mt-1">
                                            ...
                                            <?php elseif($event->start_time): ?>
                                                Starts at <?php echo e(\Carbon\Carbon::parse($event->start_time)->format('h:i A')); ?>

                                            <?php elseif($event->end_time): ?>
                                                Ends at <?php echo e(\Carbon\Carbon::parse($event->end_time)->format('h:i A')); ?>
                        ...
                        <td class="py-4 px-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->tag): ?>
                        ...
                        <td class="py-4 px-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->date): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->date->isFuture()): ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/events/index.blade.php ENDPATH**/ ?>
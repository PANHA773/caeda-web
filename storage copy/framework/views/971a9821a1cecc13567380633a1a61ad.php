...
<?php $__env->startSection('title', 'Goals & Strategies'); ?>
...
<div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            ...
            <a href="<?php echo e(route('admin.goals.create')); ?>" class="mt-4 sm:mt-0 inline-flex items-center px-4 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all shadow-sm hover:shadow-md">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-5 border border-blue-200">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($goals->count()); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-5 border border-green-200">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($goals->where('is_active', true)->count()); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-5 border border-purple-200">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($goals->max('order') ?? 0); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $goals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <td class="px-8 py-5 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-lg bg-gradient-to-br from-blue-100 to-blue-50 border border-blue-200">
                                    <span class="font-bold text-blue-700"><?php echo e($goal->order); ?></span>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-5">
                            <div class="flex flex-col space-y-1">
                                <h4 class="font-semibold text-gray-900 text-base"><?php echo e($goal->title); ?></h4>
                                <p class="text-sm text-gray-600 line-clamp-2"><?php echo e(Str::limit($goal->description, 120)); ?></p>
                                <div class="flex items-center mt-1">
                                    <span class="text-xs px-2 py-1 bg-gray-100 text-gray-700 rounded">ID: <?php echo e($goal->id); ?></span>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-5 whitespace-nowrap">
                            <div class="flex flex-col items-center space-y-2">
                                <div class="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-indigo-100 to-purple-100 border border-indigo-200">
                                    <i class="<?php echo e($goal->icon); ?> text-xl text-indigo-600"></i>
                                </div>
                                <span class="text-xs text-gray-500 font-mono"><?php echo e(Str::limit($goal->icon, 15)); ?></span>
                            </div>
                        </td>
                        <td class="px-8 py-5 whitespace-nowrap">
                            <div class="flex flex-col space-y-2">
                                ...
                                <span class="text-xs text-gray-500">Created <?php echo e($goal->created_at->diffForHumans()); ?></span>
                            </div>
                        </td>
                        <td class="px-8 py-5 whitespace-nowrap">
                            <div class="flex items-center space-x-3">
                                <a href="<?php echo e(route('admin.goals.edit', $goal->id)); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 font-medium text-sm rounded-lg border border-blue-200 hover:from-blue-100 hover:to-blue-200 hover:text-blue-800 hover:shadow-sm transition-all">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                    </svg>
                                    Edit
                                </a>
                                <form action="<?php echo e(route('admin.goals.destroy', $goal->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this goal? This action cannot be undone.');">
                                    <?php echo csrf_field(); ?>
                    ...
                    <tr>
                        <td colspan="5" class="px-8 py-12 text-center">
                            <div class="flex flex-col items-center justify-center text-gray-400">
                                ...
                                <a href="<?php echo e(route('admin.goals.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                    </svg>
                                    Create First Goal
        ...
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50/50">
            <div class="flex items-center justify-between">
                <div class="text-sm text-gray-700">
                    Showing <?php echo e($goals->firstItem()); ?> to <?php echo e($goals->lastItem()); ?> of <?php echo e($goals->total()); ?> results
                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/goals/index.blade.php ENDPATH**/ ?>
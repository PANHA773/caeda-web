...
<section class="relative py-20 px-4 md:px-8 overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
    <div class="absolute inset-0">
        ...
        <img src="<?php echo e($event->image); ?>" alt="<?php echo e($event->title); ?>" class="absolute inset-0 w-full h-full object-cover opacity-20">
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="rounded-2xl overflow-hidden shadow-2xl mb-8">
                    <img src="<?php echo e($event->image); ?>" alt="<?php echo e($event->title); ?>" class="w-full h-96 object-cover">
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->speakers > 0): ?>
                <div class="bg-white rounded-2xl p-8 shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= min(4, $event->speakers); $i++): ?>
...
<section class="py-16 px-4 md:px-8 bg-gray-50">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $relatedEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedEvent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('events.show', $relatedEvent)); ?>" class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-48 overflow-hidden">
                        <img src="<?php echo e($relatedEvent->image); ?>" alt="<?php echo e($relatedEvent->title); ?>" class="w-full h-full object-cover hover:scale-110 transition-transform duration-300">

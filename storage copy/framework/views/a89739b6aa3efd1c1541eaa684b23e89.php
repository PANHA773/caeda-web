...
<div class="container mx-auto p-6">
    ...
    <a href="<?php echo e(route('admin.speakers.create')); ?>" class="mb-4 inline-block bg-blue-500 text-white px-4 py-2 rounded">Add Speaker</a>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $speakers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $speaker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="border px-4 py-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($speaker->image): ?>
                            <img src="<?php echo e($speaker->image); ?>" alt="<?php echo e($speaker->name); ?>" class="w-16 h-16 object-cover rounded-full">
                        <?php else: ?>

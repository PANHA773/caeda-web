...
<?php $__env->startSection('title', 'Edit Vision/Mission'); ?>
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <div>
                <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-3">
                    ...
                    <span class="text-gray-400">Edit #<?php echo e($visionMission->id); ?></span>
                </nav>
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Update details for "<?php echo e(ucfirst($visionMission->type)); ?>" statement</p>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
                ...
                <div class="mt-1 flex items-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($visionMission->type == 'vision'): ?>
            ...
            <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
                ...
                <div class="mt-1 flex items-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($visionMission->is_active): ?>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
                ...
                <p class="text-lg font-semibold text-gray-900"><?php echo e(strlen($visionMission->description)); ?></p>
            </div>
            <div class="bg-gradient-to-r from-amber-50 to-amber-100 rounded-xl p-4 border border-amber-200">
                <p class="text-sm font-medium text-gray-600">Last Updated</p>
                <p class="text-lg font-semibold text-gray-900"><?php echo e($visionMission->updated_at->diffForHumans()); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-gradient-to-br from-white via-white to-gray-50 rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <form action="<?php echo e(route('admin.vision-missions.update', $visionMission->id)); ?>" method="POST" class="p-8">
                <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                <div id="typePreview" class="flex flex-col space-y-4">
                                    ...
                                    <div id="visionPreview" class="<?php echo e($visionMission->type == 'vision' ? '' : 'hidden'); ?> p-4 bg-gradient-to-r from-indigo-50 to-indigo-100/50 rounded-xl border border-indigo-200">
                                    ...
                                    <div id="missionPreview" class="<?php echo e($visionMission->type == 'mission' ? '' : 'hidden'); ?> p-4 bg-gradient-to-r from-purple-50 to-purple-100/50 rounded-xl border border-purple-200">
                                        <div class="flex items-center space-x-3">
                                    ...
                                    <div id="emptyPreview" class="<?php echo e(!in_array($visionMission->type, ['vision', 'mission']) ? '' : 'hidden'); ?> p-4 bg-gradient-to-r from-gray-50 to-gray-100/50 rounded-xl border border-gray-200">
                                        <div class="flex items-center space-x-3">
                            ...
                            <div class="relative">
                                <select name="type"
                                    ...
                                    <option value="vision" <?php echo e(old('type', $visionMission->type) == 'vision' ? 'selected' : ''); ?>>Vision Statement</option>
                                    <option value="mission" <?php echo e(old('type', $visionMission->type) == 'mission' ? 'selected' : ''); ?>>Mission Statement</option>
                                </select>
                            ...
                            <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div class="relative">
                                    <input type="checkbox"
                                           ...
                                           id="is_active"
                                           value="1"
                                           <?php echo e(old('is_active', $visionMission->is_active) ? 'checked' : ''); ?>
                                ...
                                <div>
                                    <span class="text-sm font-medium text-gray-900" id="statusText"><?php echo e($visionMission->is_active ? 'Active' : 'Hidden'); ?></span>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                      rows="8"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white hover:border-gray-400"><?php echo e(old('description', $visionMission->description)); ?></textarea>
                            <div class="flex justify-between mt-1">
                                <span class="text-xs text-gray-500">Write a clear and inspiring statement</span>
                                <span class="text-xs text-gray-400" id="charCount"><?php echo e(strlen($visionMission->description)); ?> characters</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-10 pt-8 border-t border-gray-200">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="<?php echo e(route('admin.vision-missions.create')); ?>" class="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all shadow-sm hover:shadow-md flex items-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-8 bg-gradient-to-br from-white via-white to-gray-50 rounded-2xl shadow-lg border border-red-200 overflow-hidden">
            ...
            <div class="p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <form action="<?php echo e(route('admin.vision-missions.destroy', $visionMission->id)); ?>" 
                          method="POST"
                          onsubmit="return confirm('⚠️ Are you absolutely sure? This will permanently delete this <?php echo e($visionMission->type); ?> statement and cannot be undone.');">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/vision-missions/edit.blade.php ENDPATH**/ ?>
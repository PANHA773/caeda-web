...
<?php $__env->startSection('title', 'Contact Methods'); ?>
...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <a href="<?php echo e(route('admin.contact-information.create')); ?>"
            ...
            <tbody class="divide-y divide-gray-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 font-medium text-gray-800"><?php echo e($contact->title); ?></td>
                        <td class="px-6 py-4"><i class="<?php echo e($contact->icon); ?>"></i></td>
                        <td class="px-6 py-4"><?php echo $contact->content; ?></td>
                        ...
                        <td class="px-6 py-4 text-right space-x-2">
                            <a href="<?php echo e(route('admin.contact-information.edit', $contact->id)); ?>"
                               class="inline-flex items-center px-3 py-1.5 bg-yellow-500 hover:bg-yellow-600 text-white text-sm rounded">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="<?php echo e(route('admin.contact-information.destroy', $contact->id)); ?>"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/contact-information/index.blade.php ENDPATH**/ ?>
        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div class="lg:w-1/2 text-white">
                ...
                <div class="space-y-4 mb-8" data-animate>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div class="text-center group transform transition-all duration-500 hover:scale-105"
                ...
                <div class="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r <?php echo e($stat['color']); ?> bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($welcome): ?>
        ...
        <div class="flex flex-col lg:flex-row items-start gap-12">
            ...
            <div class="lg:w-1/2">
                <div class="mb-8">
                    ...
                    <div class="space-y-4 text-lg text-gray-700 leading-relaxed">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $welcome->description; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p class="text-gray-800 transform transition-all duration-500 hover:translate-x-2 delay-<?php echo e($index * 100); ?>">
                            <?php echo $paragraph; ?>
            ...
            <div class="lg:w-1/2 relative">
                <div class="relative transform transition-all duration-500 hover:scale-105">
                    <img src="<?php echo e($welcome->image); ?>" alt="Caeda Campus"
                        class="rounded-3xl shadow-2xl w-full h-96 object-cover border-4 border-white shadow-lg backdrop-blur-sm">

                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($welcome->badges): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $welcome->badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="absolute <?php echo e($badge['position'] ?? '-top-4 -right-4'); ?> 
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($welcome->stats): ?>
                <div class="grid grid-cols-2 gap-6 mt-12">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $welcome->stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl
                ...
                <div class="relative overflow-hidden">
                    <img src="<?php echo e($program->image ?: 'https://via.placeholder.com/800x480'); ?>"
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="group bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg text-center hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border border-gray-100/50"
                style="animation-delay: <?php echo e($index * 200); ?>ms">
                <div class="w-20 h-20 bg-gradient-to-br <?php echo e($feature->color); ?> rounded-3xl flex items-center justify-center mx-auto mb-6 transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-12">
...
<section data-animate class="py-20 px-4 md:px-8 bg-gradient-to-br from-blue-50/50 to-purple-50/50 backdrop-blur-sm">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="relative max-w-4xl mx-auto" style="min-height: 300px">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $instructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div data-testimonial
                ...
                <div class="flex flex-col md:flex-row items-start gap-6 mb-6">
                    <div class="relative">
                        <img src="<?php echo e($instructor['image_url']); ?>"
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex mt-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < 5; $i++): ?>
                                <span class="text-xl transform transition-all duration-300 <?php echo e($i < $instructor['rating'] ? 'text-yellow-400 hover:scale-125' : 'text-gray-300'); ?>">
                                ★
                                </span>
...
<section class="w-full relative overflow-hidden py-32 bg-gradient-to-r from-blue-900 via-purple-900 to-indigo-900 text-white">
    
    <div class="absolute inset-0 bg-black/20"></div>

    
    <div class="absolute top-0 -left-16 w-96 h-96 bg-blue-600/30 rounded-full blur-3xl animate-pulse-slow"></div>
    <div class="absolute bottom-0 -right-16 w-96 h-96 bg-purple-600/30 rounded-full blur-3xl animate-pulse-slow delay-1000"></div>

    
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        
        <h2 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent font-cinzel">
        ...
        <div class="flex flex-col sm:flex-row justify-center items-center gap-5">
            <button class="group relative bg-yellow-400 text-blue-900 font-bold py-4 px-10 rounded-xl shadow-xl hover:bg-yellow-300 hover:-translate-y-1 transform transition-all duration-300">
                Get Started Now
                <span class="absolute inset-0 rounded-xl border-2 border-yellow-300 opacity-0 group-hover:opacity-100 transition-all duration-300"></span>
            </button>

            <button class="group relative border-2 border-white text-white font-semibold py-4 px-10 rounded-xl backdrop-blur-sm hover:bg-white/20 transition-all duration-300">
                Contact Us
                <span class="absolute inset-0 rounded-xl bg-white/10 opacity-0 group-hover:opacity-100 transition-all duration-300"></span>
            </button>
        </div>
    </div>
</section>

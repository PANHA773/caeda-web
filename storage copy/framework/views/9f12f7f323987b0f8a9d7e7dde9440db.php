...
<?php $__env->startSection('title', 'Edit Milestone'); ?>
...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.milestones.update', $milestone->id)); ?>"
          method="POST"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="year"
                       value="<?php echo e(old('year', $milestone->year)); ?>"
            ...
            <div>
                ...
                <input type="number" name="order"
                       value="<?php echo e(old('order', $milestone->order)); ?>"
                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
            </div>
        </div>
        ...
        <div>
            ...
            <input type="text" name="title"
                   value="<?php echo e(old('title', $milestone->title)); ?>"
                   class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
        </div>
        ...
        <div>
            ...
            <textarea name="description" rows="4"
                      class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('description', $milestone->description)); ?></textarea>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="icon"
                       value="<?php echo e(old('icon', $milestone->icon)); ?>"
                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div>
                ...
                <input type="text" name="color"
                       value="<?php echo e(old('color', $milestone->color)); ?>"
                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
            </div>
        </div>
...
Digital Transformation Leader"><?php echo e(old('achievements_text', implode("\n", $milestone->achievements ?? []))); ?></textarea>
        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/admin/milestones/edit.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Contact Us - CAEDA'); ?>
...
<section class="py-16 bg-gradient-to-r from-gray-50 via-blue-50/30 to-purple-50/30">
    <div class="max-w-7xl mx-auto px-4 md:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $contactStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="text-center group animate-fade-in-up" style="animation-delay: <?php echo e($index * 150); ?>ms">
                <div class="relative inline-block mb-4">
                    <div class="w-20 h-20 bg-gradient-to-br <?php echo e($stat['color']); ?> rounded-2xl flex items-center justify-center mx-auto mb-2 transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-12">
                        <i class="<?php echo e($stat['icon']); ?> text-white text-3xl"></i>
                    </div>
                    <div class="absolute -inset-2 bg-gradient-to-br <?php echo e($stat['color']); ?> rounded-2xl blur-md opacity-0 group-hover:opacity-30 transition-opacity duration-500 -z-10"></div>
                </div>
                <div class="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r <?php echo e($stat['color']); ?> bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
...
<div class="animate-fade-in-up">
    <div class="glass-effect rounded-3xl p-8 shadow-2xl">
        ...
        <form id="contactForm" class="space-y-6" action="<?php echo e(route('contact.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-field','data' => ['name' => 'first_name','label' => 'First Name *','icon' => 'fas fa-user','placeholder' => 'John','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'first_name','label' => 'First Name *','icon' => 'fas fa-user','placeholder' => 'John','required' => true]); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal13afeff3c398c925ed332806e702df71 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal13afeff3c398c925ed332806e702df71 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-field','data' => ['name' => 'last_name','label' => 'Last Name *','icon' => 'fas fa-user','placeholder' => 'Doe','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-field'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'last_name','label' => 'Last Name *','icon' => 'fas fa-user','placeholder' => 'Doe','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal13afeff3c398c925ed332806e702df71)): ?>
<?php $attributes = $__attributesOriginal13afeff3c398c925ed332806e702df71; ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal13afeff3c398c925ed332806e702df71 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal13afeff3c398c925ed332806e702df71 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-field','data' => ['name' => 'email','label' => 'Email Address *','icon' => 'fas fa-envelope','placeholder' => 'john@example.com','type' => 'email','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-field'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'email','label' => 'Email Address *','icon' => 'fas fa-envelope','placeholder' => 'john@example.com','type' => 'email','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal13afeff3c398c925ed332806e702df71)): ?>
<?php $attributes = $__attributesOriginal13afeff3c398c925ed332806e702df71; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal13afeff3c398c925ed332806e702df71 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal13afeff3c398c925ed332806e702df71 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-field','data' => ['name' => 'phone','label' => 'Phone Number','icon' => 'fas fa-phone','placeholder' => '+855 12 345 678']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-field'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'phone','label' => 'Phone Number','icon' => 'fas fa-phone','placeholder' => '+855 12 345 678']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal13afeff3c398c925ed332806e702df71)): ?>
<?php $attributes = $__attributesOriginal13afeff3c398c925ed332806e702df71; ?>
            ...
            <div class="space-y-8 animate-fade-in-up" style="animation-delay: 200ms">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="contact-card-hover bg-white/50 p-6 rounded-2xl border border-gray-200 hover:border-transparent transition-all duration-300 group">
                            <div class="flex items-start">
                                <div class="w-14 h-14 bg-gradient-to-br <?php echo e($contact->color); ?> rounded-xl flex items-center justify-center mr-4 transform transition-all duration-300 group-hover:scale-110">
                                    <i class="<?php echo e($contact->icon); ?> text-white text-xl"></i>
                                </div>
                                <div class="flex-1">
                                    <h3 class="font-bold text-gray-900 text-lg mb-2"><?php echo e($contact->title); ?></h3>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($contact->action): ?>
                            <button onclick="contactAction('<?php echo e(strtolower($contact->title)); ?>')"
                                ...
                                <i class="<?php echo e($contact->action_icon); ?> mr-2"></i>
                                <?php echo e($contact->action); ?>
                ...
                <div class="glass-effect rounded-3xl p-8 shadow-2xl">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $socialLinks ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e($social->url); ?>"
                            target="_blank"
                            rel="noopener noreferrer"
                            title="<?php echo e($social->platform); ?>"
                            class="w-14 h-14 <?php echo e($social->color); ?>
...
<section class="py-20 px-4 md:px-8 bg-white">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $faqs->chunk(ceil($faqs->count()/2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="space-y-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $column; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="faq-item bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 cursor-pointer animate-fade-in-up" style="animation-delay: <?php echo e($index * 100); ?>ms">
                    <div class="flex items-start">
                        <div class="w-12 h-12 bg-gradient-to-br <?php echo e($faq->color == 'blue' ? 'from-blue-500 to-cyan-500' : 
                                    ($faq->color == 'purple' ? 'from-purple-500 to-pink-500' : 
                                    ($faq->color == 'green' ? 'from-green-500 to-teal-500' : 'from-orange-500 to-red-500'))); ?> rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                            <i class="<?php echo e($faq->icon); ?> text-white"></i>
                        </div>
                        <div class="flex-1">
                            <h4 class="font-bold text-gray-900 text-lg mb-2"><?php echo e($faq->question); ?></h4>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\web-caeda\caeda-web\resources\views/contact.blade.php ENDPATH**/ ?>